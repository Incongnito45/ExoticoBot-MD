...
import './EXOTICO/conexion/archivos.js'
...
this.sendMessage(m.chat, {text: `᥀·࣭࣪̇˖🪙◗ 𝙉𝙤 𝙩𝙞𝙚𝙣𝙚𝙨 𝙨𝙪𝙛𝙞𝙘𝙞𝙚𝙣𝙩𝙚𝙨 𝘽𝙤𝙩𝘾𝙤𝙞𝙣𝙨 𝙥𝙖𝙧𝙖 𝙪𝙨𝙖𝙧 𝙚𝙨𝙩𝙚 𝙘𝙤𝙢𝙖𝙣𝙙𝙤.`,  contextInfo: {externalAdReply :{ mediaUrl: null, mediaType: 1, description: null, title: wm, body: ' ⌔ִ𝅄⧉𝅦 𝘌𝘹𝘰𝘵𝘪𝘤𝘰𝘉𝘰𝘵-𝘔𝘋 ┃ 𝘔𝘶𝘭𝘵𝘪𝘉𝘰𝘵-𝘔𝘋𝅦 𝆭  𝅦 𝆭 ', previewType: 0, thumbnail: imagenRB, sourceUrl: exoticoAll }}}, { quoted: m })         
continue     
}
			
m.exp += xp
if (!isPrems && plugin.limit && global.db.data.users[m.sender].limit < plugin.limit * 1) {
this.sendMessage(m.chat, {text: `᥀·࣭࣪̇˖💎◗ 𝙉𝙤 𝙩𝙞𝙚𝙣𝙚𝙨 𝙨𝙪𝙛𝙞𝙘𝙞𝙚𝙣𝙩𝙚𝙨 𝘿𝙞𝙖𝙢𝙖𝙣𝙩𝙚𝙨 𝙥𝙖𝙧𝙖 𝙪𝙨𝙖𝙧 𝙚𝙨𝙩𝙚 𝙘𝙤𝙢𝙖𝙣𝙙𝙤. 𝙋𝙖𝙧𝙖 𝙘𝙤𝙢𝙥𝙧𝙖𝙧 𝙢𝙖𝙨 𝙙𝙞𝙖𝙢𝙖𝙣𝙩𝙚𝙨, 𝙪𝙨𝙚 𝙚𝙨𝙩𝙚 𝙘𝙤𝙢𝙖𝙣𝙙𝙤.\n\n• 𝙋𝙤𝙧 𝙚𝙟𝙚𝙢𝙥𝙡𝙤:\n\n*${usedPrefix}buyall*\n*${usedPrefix}buy*`,  contextInfo: {externalAdReply :{ mediaUrl: null, mediaType: 1, description: null, title: wm, body: ' ⌔ִ𝅄⧉𝅦 𝘌𝘹𝘰𝘵𝘪𝘤𝘰𝘉𝘰𝘵-𝘔𝘋 ┃ 𝘔𝘶𝘭𝘵𝘪𝘉𝘰𝘵-𝘔𝘋𝅦 𝆭  𝅦 𝆭 ', previewType: 0, thumbnail: imagenRB, sourceUrl: exoticoAll }}}, { quoted: m })         
continue
}

if (!isPrems && plugin.exoticocoins && global.db.data.users[m.sender].exoticocoins < plugin.exoticocoins * 1) {
this.sendMessage(m.chat, {text: `᥀·࣭࣪̇˖☁️◗ 𝙉𝙤 𝙩𝙞𝙚𝙣𝙚𝙨 𝙨𝙪𝙛𝙞𝙘𝙞𝙚𝙣𝙩𝙚𝙨 𝙎𝙚𝙧𝙫𝙚𝙧𝘾𝙤𝙞𝙣𝙨 𝙥𝙖𝙧𝙖 𝙪𝙨𝙖𝙧 𝙚𝙨𝙩𝙚 𝙘𝙤𝙢𝙖𝙣𝙙𝙤. 𝙋𝙖𝙧𝙖 𝙘𝙤𝙢𝙥𝙧𝙖𝙧 𝙢𝙖𝙨 𝙨𝙚𝙧𝙫𝙚𝙧𝙘𝙤𝙞𝙣𝙨, 𝙪𝙨𝙚 𝙚𝙨𝙩𝙚 𝙘𝙤𝙢𝙖𝙣𝙙𝙤.\n\n• 𝙋𝙤𝙧 𝙚𝙟𝙚𝙢𝙥𝙡𝙤:\n\n*${usedPrefix}buyallcoins*\n*${usedPrefix}buycoins*\n\n• 𝙑𝙞𝙨𝙞𝙩𝙖 𝙡𝙖 𝙩𝙞𝙚𝙣𝙙𝙖 𝙚𝙣: #tiendaexotico`,  contextInfo: {externalAdReply :{ mediaUrl: null, mediaType: 1, description: null, title: wm, body: ' ⌔ִ𝅄⧉𝅦 𝘌𝘹𝘰𝘵𝘪𝘤𝘰𝘉𝘰𝘵-𝘔𝘋 ┃ 𝘔𝘶𝘭𝘵𝘪𝘉𝘰𝘵-𝘔𝘋𝅦 𝆭  𝅦 𝆭 ', previewType: 0, thumbnail: imagenRB, sourceUrl: exoticoAll }}}, { quoted: m })         
continue
}

if (!isPrems && plugin.exoticoserver && global.db.data.users[m.sender].exoticoserver < plugin.exoticoserver * 1) {
this.sendMessage(m.chat, {text: `᥀·࣭࣪̇˖🖥️◗ 𝙉𝙤 𝙩𝙞𝙚𝙣𝙚𝙨 𝙡𝙤 𝙨𝙪𝙛𝙞𝙘𝙞𝙚𝙣𝙩𝙚 𝙥𝙖𝙧𝙖 𝙘𝙤𝙢𝙥𝙧𝙖𝙧 𝙪𝙣 𝙎𝙚𝙧𝙫𝙞𝙙𝙤𝙧, 𝙥𝙖𝙧𝙖 𝙘𝙤𝙢𝙥𝙧𝙖𝙧 𝙪𝙣 𝙎𝙚𝙧𝙫𝙞𝙙𝙤𝙧, 𝙪𝙨𝙚 𝙚𝙨𝙩𝙚 𝙘𝙤𝙢𝙖𝙣𝙙𝙤.\n\n• 𝙋𝙤𝙧 𝙚𝙟𝙚𝙢𝙥𝙡𝙤:\n\n*${usedPrefix}buyserver*\n\n• 𝙑𝙞𝙨𝙞𝙩𝙖 𝙡𝙖 𝙩𝙞𝙚𝙣𝙙𝙖 𝙚𝙣: #tiendaexotico`,  contextInfo: {externalAdReply :{ mediaUrl: null, mediaType: 1, description: null, title: wm, body: ' ⌔ִ𝅄⧉𝅦 𝘌𝘹𝘰𝘵𝘪𝘤𝘰𝘉𝘰𝘵-𝘔𝘋 ┃ 𝘔𝘶𝘭𝘵𝘪𝘉𝘰𝘵-𝘔𝘋𝅦 𝆭  𝅦 𝆭 ', previewType: 0, thumbnail: imagenRB, sourceUrl: exoticoAll }}}, { quoted: m })         
continue
}

if (!isPrems && plugin.exoticopaquete && global.db.data.users[m.sender].exoticopaquete < plugin.exoticopaquete * 1) {
this.sendMessage(m.chat, {text: `᥀·࣭࣪̇˖🎁◗ 𝙉𝙤 𝙩𝙞𝙚𝙣𝙚𝙨 𝙣𝙞𝙣𝙜𝙪𝙣 𝙥𝙖𝙦𝙪𝙚𝙩𝙚 𝙥𝙖𝙧𝙖 𝙖𝙗𝙧𝙞𝙧𝙡𝙤, 𝙘𝙤𝙢𝙥𝙧𝙖 𝙪𝙣𝙤 𝙪𝙨𝙖𝙣𝙙𝙤 𝙚𝙨𝙩𝙚 𝙘𝙤𝙢𝙖𝙣𝙙𝙤.\n\n• 𝙋𝙤𝙧 𝙚𝙟𝙚𝙢𝙥𝙡𝙤:\n\n*${usedPrefix}buyallpaquetes*\n*${usedPrefix}buypaquete*\n\n• 𝙑𝙞𝙨𝙞𝙩𝙖 𝙡𝙖 𝙩𝙞𝙚𝙣𝙙𝙖 𝙚𝙣: #tiendaexotico`,  contextInfo: {externalAdReply :{ mediaUrl: null, mediaType: 1, description: null, title: wm, body: ' ⌔ִ𝅄⧉𝅦 𝘌𝘹𝘰𝘵𝘪𝘤𝘰𝘉𝘰𝘵-𝘔𝘋 ┃ 𝘔𝘶𝘭𝘵𝘪𝘉𝘰𝘵-𝘔𝘋𝅦 𝆭  𝅦 𝆭 ', previewType: 0, thumbnail: imagenRB, sourceUrl: exoticoAll }}}, { quoted: m })         
continue
}

if (plugin.level > _user.level) {
this.sendMessage(m.chat, {text: `᥀·࣭࣪̇˖🌆◗ 𝙍𝙚𝙦𝙪𝙞𝙚𝙧𝙚𝙨 𝙚𝙡 𝙣𝙞𝙫𝙚𝙡: *${plugin.level}*\n\n• 𝙏𝙪 𝙣𝙞𝙫𝙚𝙡 𝙖𝙘𝙩𝙪𝙖𝙡 𝙚𝙨: *${_user.level}*\n\n• 𝙐𝙨𝙖 𝙚𝙨𝙩𝙚 𝙘𝙤𝙢𝙖𝙣𝙙𝙤 𝙥𝙖𝙧𝙖 𝙨𝙪𝙗𝙞𝙧 𝙙𝙚 𝙣𝙞𝙫𝙚𝙡:\n*${usedPrefix}levelup*`,  contextInfo: {externalAdReply :{ mediaUrl: null, mediaType: 1, description: null, title: wm, body: ' ⌔ִ𝅄⧉𝅦 𝘌𝘹𝘰𝘵𝘪𝘤𝘰𝘉𝘰𝘵-𝘔𝘋 ┃ 𝘔𝘶𝘭𝘵𝘪𝘉𝘰𝘵-𝘔𝘋𝅦 𝆭  𝅦 𝆭 ', previewType: 0, thumbnail: imagenRB, sourceUrl: exoticoAll }}}, { quoted: m })         
continue
}
let extra = {
match,
...
if (m.limit)
m.reply('᥀·࣭࣪̇˖💎◗ 𝙂𝙖𝙨𝙩𝙖𝙨𝙩𝙚 ' + m.limit + ' 𝙙𝙚 𝘿𝙞𝙖𝙢𝙖𝙣𝙩𝙚(𝙨)')

if (m.exoticocoins)
m.reply('᥀·࣭࣪̇˖☁️◗ 𝙂𝙖𝙨𝙩𝙖𝙨𝙩𝙚 ' + m.exoticocoins + ' 𝙙𝙚 𝙎𝙚𝙧𝙫𝙚𝙧𝘾𝙤𝙞𝙣𝙨(𝙨)')

if (m.exoticoserver)
m.reply('᥀·࣭࣪̇˖💻◗ 𝘾𝙤𝙢𝙥𝙧𝙖𝙨𝙩𝙚 ' + m.exoticoserver + ' 𝙙𝙚 𝙎𝙚𝙧𝙫𝙞𝙙𝙤𝙧(𝙚𝙨)')

if (m.exoticopaquete)
m.reply('᥀·࣭࣪̇˖🎁◗ 𝘼𝙗𝙧𝙞𝙨𝙩𝙚 ' + m.exoticopaquete + ' 𝙋𝙖𝙦𝙪𝙚𝙩𝙚.')
}
if (m.money)
m.reply('᥀·࣭࣪̇˖🪙◗ 𝙂𝙖𝙨𝙩𝙖𝙨𝙩𝙚 ' + m.money + ' 𝙙𝙚 𝘽𝙤𝙩𝘾𝙤𝙞𝙣(𝙨)')  
break
}}} catch (e) {
console.error(e)
} finally {
...
text = (action === 'add' ? (chat.sWelcome || this.welcome || conn.welcome || 'Welcome, @user!').replace('@subject', await this.getName(id)).replace('@desc', groupMetadata.desc?.toString() || '𝗘𝘅𝗼𝘁𝗶𝗰𝗼𝗕𝗼𝘁-𝗠𝗗\n\n• 𝗚𝗿𝘂𝗽𝗼 𝘀𝗶𝗻 𝗱𝗲𝘀𝗰𝗿𝗶𝗽𝗰𝗶𝗼𝗻.') :
...
"thumbnail": apii.data, 
"title": [wm, packname, '𝙀𝙭𝙤𝙩𝙞𝙘𝙤𝘽𝙤𝙩-𝙈𝘿 / 𝘔𝘶𝘭𝘵𝘪𝘉𝘰𝘵'].getRandom(),
...
if (nk.isGroup == false) {
if (nk.status == "offer") {
let callmsg = await this.reply(nk.from, `᥀·࣭࣪̇˖☎️◗ 𝙃𝙤𝙡𝙖 *@${nk.from.split('@')[0]}*, 𝙡𝙖𝙨 ${nk.isVideo ? '𝙡𝙡𝙖𝙢𝙖𝙙𝙖𝙨' : '𝙫𝙞𝙙𝙚𝙤 𝙡𝙡𝙖𝙢𝙖𝙙𝙖𝙨'} 𝙣𝙤 𝙚𝙨𝙩𝙖𝙣 𝙥𝙚𝙧𝙢𝙞𝙩𝙞𝙙𝙖𝙨 𝙚𝙣 𝙚𝙨𝙩𝙚 𝙗𝙤𝙩.\n\n• 𝙀𝙣 𝙘𝙖𝙨𝙤 𝙙𝙚 𝙪𝙣 𝙚𝙧𝙧𝙤𝙧, 𝙘𝙤𝙣𝙩𝙖𝙘𝙩𝙖 𝙘𝙤𝙣 𝙚𝙡 𝙘𝙧𝙚𝙖𝙙𝙤𝙧:\n• ${creador}`, false, { mentions: [nk.from] })
...
let msg = {
rowner: `𝇇•─•〘𝆭🌌𝆺𝅥𝙀𝙭𝙤𝙩𝙞𝙘𝆭𝙤𝘽𝙤𝙩-𝙈𝘿𝆹𝅥🌌𝆭〙•─•𝇇\n⬪ํٜ•────────•𝅃۬𝆹𝅥🪐𝆺𝅥⸱𝅃•────────•ํٜ⬪\n\n⌔ִ𝅄⧉𝅦 𝙀𝙎𝙏𝙀 𝘾𝙊𝙈𝘼𝙉𝘿𝙊 𝙎𝙊𝙇𝙊 𝙋𝙐𝙀𝘿𝙀 𝙎𝙀𝙍 𝙐𝙏𝙄𝙇𝙄𝙕𝘼𝘿𝙊 𝙋𝙊𝙍 𝙇𝙊𝙎 𝙊𝙒𝙉𝙀𝙍𝙎 𝘿𝙀𝙇 𝘽𝙊𝙏.`,
