const ExoticoLang = () => { return 'es' } 
//CODIGO DE GATA BOT MD
//Tienda
...
const eBotCoins = () => { return '🐱 GataCoins' }
const eBotTickers = () => { return '🎫 Gata Tickers' } 
...
export default { ExoticoLang, eBarraOro, ePocion, eExp, eDiamante, eDiamantePlus, eEsmeralda, eToken, eMagia, eJoya, eOro, eBotCoins, eBotTickers, eEnergia, eMadera, eBasura, eAgua, ePiedra, eRoca, eCuerda, eHierro, eEletric, eCarton, eLata, eBotella, eCarbon,  eCFenix, eACaballo, eCDragon, eCMagica, eCAve, eCCentauro, eAMascots, ePerro, eLobo, eFenix, eCaballo, eZorro, eDragon, eGato, eAve, eCentauro, eSPlatano, eSMango, eSNaranja, eManzana, eUva, eClegendaria, eCJardineria, eCMascota, eCMistica, ePComun, eCComun, eCanaPescar, eGancho, ePinata, eCarnada, eEspada, eLoboG, eZorroG, eMaderaG, eOroComun, eBasuraG, }
