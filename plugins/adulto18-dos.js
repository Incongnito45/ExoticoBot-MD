...
let frep = { contextInfo: { externalAdReply: {title: '᥀·࣭࣪̇˖🌌◗ 𝙀𝙭𝙤𝙩𝙞𝙘𝙤𝘽𝙤𝙩-𝙈𝘿... ✯✨', body: ' 🍾 𝘕𝘰 𝘷𝘦𝘢𝘴 𝘦𝘴𝘵𝘢𝘴 𝘤𝘰𝘴𝘢𝘴 𝘱𝘢𝘫𝘪𝘯 🥃 ', sourceUrl: exoticoAll, thumbnail: await(await fetch(imagenRB)).buffer() }}}
let user = global.db.data.users[m.sender]
if (!db.data.chats[m.chat].modohorny && m.isGroup) throw `᥀·࣭࣪̇˖🛡️◗ Los comandos para adultos estan prohibidos, pero si eres admin de un grupo, puedes activarlo ahi usando el comando: *#on modohorny*` 
...
await conn.sendFile(m.chat, stickerr, 'sticker.webp', '', m, true, { contextInfo: { 'forwardingScore': 200, 'isForwarded': false, externalAdReply:{ showAdAttribution: false, title: '『🎉 𝙀𝙭𝙤𝙩𝙞𝙘𝙤𝘽𝙤𝙩-𝙈𝘿 🎉』', body: ' 🍾 𝘕𝘰 𝘷𝘦𝘢𝘴 𝘦𝘴𝘵𝘢𝘴 𝘤𝘰𝘴𝘢𝘴 𝘱𝘢𝘫𝘪𝘯 🥃 ', mediaType: 2, sourceUrl: exoticoAll, thumbnail: await(await fetch(img16)).buffer()}}}, { quoted: m })
await conn.sendFile(m.chat, null, null, `᥀·࣭࣪̇˖🌌◗ 𝙀𝙭𝙤𝙩𝙞𝙘𝙤𝘽𝙤𝙩-𝙈𝘿... ✯✨`, null, null, {viewOnce: true}, m)
//await conn.sendButton(m.chat, '『🎉 𝙀𝙭𝙤𝙩𝙞𝙘𝙤𝘽𝙤𝙩-𝙈𝘿 🎉』', `᥀·࣭࣪̇˖🌌◗ 𝙀𝙭𝙤𝙩𝙞𝙘𝙤𝘽𝙤𝙩-𝙈𝘿... ✯✨\n` + ' 🍾 𝘕𝘰 𝘷𝘦𝘢𝘴 𝘦𝘴𝘵𝘢𝘴 𝘤𝘰𝘴𝘢𝘴 𝘱𝘢𝘫𝘪𝘯 🥃 ' + ` : *${command[0].toUpperCase() + command.substring(1)}*`, null, [['𝙑𝙚𝙧 𝙤𝙩𝙧𝙤 🍹', `${usedPrefix + command}`], [`🔥 ${lenguajeMT.lenguaje() == 'es' ? 'porno hentai' : 'nsfw hentai'} 🔥`.toUpperCase(), `${usedPrefix}${lenguajeMT.lenguaje() == 'es' ? 'pornohentai' : 'nsfwhentai'}`]], fkontak, m)
}else{
await conn.sendFile(m.chat, link, null, `᥀·࣭࣪̇˖🌌◗ 𝙀𝙭𝙤𝙩𝙞𝙘𝙤𝘽𝙤𝙩-𝙈𝘿... ✯✨`, null, null, {viewOnce: true}, m)}}
//await conn.sendButton(m.chat, '『🎉 𝙀𝙭𝙤𝙩𝙞𝙘𝙤𝘽𝙤𝙩-𝙈𝘿 🎉』', `᥀·࣭࣪̇˖🌌◗ 𝙀𝙭𝙤𝙩𝙞𝙘𝙤𝘽𝙤𝙩-𝙈𝘿... ✯✨\n` + ' 🍾 𝘕𝘰 𝘷𝘦𝘢𝘴 𝘦𝘴𝘵𝘢𝘴 𝘤𝘰𝘴𝘢𝘴 𝘱𝘢𝘫𝘪𝘯 🥃 ' + ` : *${command[0].toUpperCase() + command.substring(1)}*`, link, [['𝙑𝙚𝙧 𝙤𝙩𝙧𝙤 🍹', `${usedPrefix + command}`], [`🔥 ${lenguajeMT.lenguaje() == 'es' ? 'porno hentai' : 'nsfw hentai'} 🔥`.toUpperCase(), `${usedPrefix}${lenguajeMT.lenguaje() == 'es' ? 'pornohentai' : 'nsfwhentai'}`]], m, frep)}}
...
let stickerr = await sticker(false, link, global.packname, global.author)
await conn.sendFile(m.chat, stickerr, 'sticker.webp', '', m, true, { contextInfo: { 'forwardingScore': 200, 'isForwarded': false, externalAdReply:{ showAdAttribution: false, title: '『🎉 𝙀𝙭𝙤𝙩𝙞𝙘𝙤𝘽𝙤𝙩-𝙈𝘿 🎉』', body: ' 🍾 𝘕𝘰 𝘷𝘦𝘢𝘴 𝘦𝘴𝘵𝘢𝘴 𝘤𝘰𝘴𝘢𝘴 𝘱𝘢𝘫𝘪𝘯 🥃 ', mediaType: 2, sourceUrl: exoticoAll, thumbnail: await(await fetch(img16)).buffer()}}}, { quoted: m })
await conn.sendFile(m.chat, null, `᥀·࣭࣪̇˖🌌◗ 𝙀𝙭𝙤𝙩𝙞𝙘𝙤𝘽𝙤𝙩-𝙈𝘿... ✯✨`, null, null, {viewOnce: true}, m)
//await conn.sendButton(m.chat, '『🎉 𝙀𝙭𝙤𝙩𝙞𝙘𝙤𝘽𝙤𝙩-𝙈𝘿 🎉』', `᥀·࣭࣪̇˖🌌◗ 𝙀𝙭𝙤𝙩𝙞𝙘𝙤𝘽𝙤𝙩-𝙈𝘿... ✯✨\n` + ' 🍾 𝘕𝘰 𝘷𝘦𝘢𝘴 𝘦𝘴𝘵𝘢𝘴 𝘤𝘰𝘴𝘢𝘴 𝘱𝘢𝘫𝘪𝘯 🥃 ' + ` : *${command[0].toUpperCase() + command.substring(1)}*`, null, [['𝙑𝙚𝙧 𝙤𝙩𝙧𝙤 🍹', `${usedPrefix + command}`], [`🔥 ${lenguajeMT.lenguaje() == 'es' ? 'porno ass' : 'nsfw ass'} 🔥`.toUpperCase(), `${usedPrefix}${lenguajeMT.lenguaje() == 'es' ? 'pornoass' : 'nsfwass'}`]], fkontak, m)
}else{
await conn.sendFile(m.chat, link, null, `᥀·࣭࣪̇˖🌌◗ 𝙀𝙭𝙤𝙩𝙞𝙘𝙤𝘽𝙤𝙩-𝙈𝘿... ✯✨`, null, null, {viewOnce: true}, m)}}
//await conn.sendButton(m.chat, '『🎉 𝙀𝙭𝙤𝙩𝙞𝙘𝙤𝘽𝙤𝙩-𝙈𝘿 🎉』', `᥀·࣭࣪̇˖🌌◗ 𝙀𝙭𝙤𝙩𝙞𝙘𝙤𝘽𝙤𝙩-𝙈𝘿... ✯✨\n` + ' 🍾 𝘕𝘰 𝘷𝘦𝘢𝘴 𝘦𝘴𝘵𝘢𝘴 𝘤𝘰𝘴𝘢𝘴 𝘱𝘢𝘫𝘪𝘯 🥃 ' + ` : *${command[0].toUpperCase() + command.substring(1)}*`, link, [['𝙑𝙚𝙧 𝙤𝙩𝙧𝙤 🍹', `${usedPrefix + command}`], [`🔥 ${lenguajeMT.lenguaje() == 'es' ? 'porno ass' : 'nsfw ass'} 🔥`.toUpperCase(), `${usedPrefix}${lenguajeMT.lenguaje() == 'es' ? 'pornoass' : 'nsfwass'}`]], m, frep)}}
...
await conn.sendFile(m.chat, stickerr, 'sticker.webp', '', m, true, { contextInfo: { 'forwardingScore': 200, 'isForwarded': false, externalAdReply:{ showAdAttribution: false, title: '『🎉 𝙀𝙭𝙤𝙩𝙞𝙘𝙤𝘽𝙤𝙩-𝙈𝘿 🎉』', body: ' 🍾 𝘕𝘰 𝘷𝘦𝘢𝘴 𝘦𝘴𝘵𝘢𝘴 𝘤𝘰𝘴𝘢𝘴 𝘱𝘢𝘫𝘪𝘯 🥃 ', mediaType: 2, sourceUrl: exoticoAll, thumbnail: await(await fetch(img16)).buffer()}}}, { quoted: m })
await conn.sendFile(m.chat, null, null, `᥀·࣭࣪̇˖🌌◗ 𝙀𝙭𝙤𝙩𝙞𝙘𝙤𝘽𝙤𝙩-𝙈𝘿... ✯✨`, null, null, {viewOnce: true}, m)
//await conn.sendButton(m.chat, '『🎉 𝙀𝙭𝙤𝙩𝙞𝙘𝙤𝘽𝙤𝙩-𝙈𝘿 🎉』', `᥀·࣭࣪̇˖🌌◗ 𝙀𝙭𝙤𝙩𝙞𝙘𝙤𝘽𝙤𝙩-𝙈𝘿... ✯✨\n` + ' 🍾 𝘕𝘰 𝘷𝘦𝘢𝘴 𝘦𝘴𝘵𝘢𝘴 𝘤𝘰𝘴𝘢𝘴 𝘱𝘢𝘫𝘪𝘯 🥃 ' + ` : *${command[0].toUpperCase() + command.substring(1)}*`, null, [['𝙑𝙚𝙧 𝙤𝙩𝙧𝙤 🍹', `${usedPrefix + command}`], [IDexotic.botonVerA, usedPrefix + 'listaporno']], fkontak, m)
}else{
await conn.sendFile(m.chat, link, null, `᥀·࣭࣪̇˖🌌◗ 𝙀𝙭𝙤𝙩𝙞𝙘𝙤𝘽𝙤𝙩-𝙈𝘿... ✯✨`, null, null, {viewOnce: true}, m)}}
//await conn.sendButton(m.chat, '『🎉 𝙀𝙭𝙤𝙩𝙞𝙘𝙤𝘽𝙤𝙩-𝙈𝘿 🎉』', `᥀·࣭࣪̇˖🌌◗ 𝙀𝙭𝙤𝙩𝙞𝙘𝙤𝘽𝙤𝙩-𝙈𝘿... ✯✨\n` + ' 🍾 𝘕𝘰 𝘷𝘦𝘢𝘴 𝘦𝘴𝘵𝘢𝘴 𝘤𝘰𝘴𝘢𝘴 𝘱𝘢𝘫𝘪𝘯 🥃 ' + ` : *${command[0].toUpperCase() + command.substring(1)}*`, link, [['𝙑𝙚𝙧 𝙤𝙩𝙧𝙤 🍹', `${usedPrefix + command}`], [IDexotic.botonVerA, usedPrefix + 'listaporno']], m, frep)}}
...
let stickerr = await sticker(false, link, global.packname, global.author)
await conn.sendFile(m.chat, stickerr, 'sticker.webp', '', m, true, { contextInfo: { 'forwardingScore': 200, 'isForwarded': false, externalAdReply:{ showAdAttribution: false, title: '『🎉 𝙀𝙭𝙤𝙩𝙞𝙘𝙤𝘽𝙤𝙩-𝙈𝘿 🎉』', body: ' 🍾 𝘕𝘰 𝘷𝘦𝘢𝘴 𝘦𝘴𝘵𝘢𝘴 𝘤𝘰𝘴𝘢𝘴 𝘱𝘢𝘫𝘪𝘯 🥃 ', mediaType: 2, sourceUrl: exoticoAll, thumbnail: await(await fetch(img16)).buffer()}}}, { quoted: m })
await conn.sendButton(m.chat, '『🎉 𝙀𝙭𝙤𝙩𝙞𝙘𝙤𝘽𝙤𝙩-𝙈𝘿 🎉』', `᥀·࣭࣪̇˖🌌◗ 𝙀𝙭𝙤𝙩𝙞𝙘𝙤𝘽𝙤𝙩-𝙈𝘿... ✯✨\n` + ' 🍾 𝘕𝘰 𝘷𝘦𝘢𝘴 𝘦𝘴𝘵𝘢𝘴 𝘤𝘰𝘴𝘢𝘴 𝘱𝘢𝘫𝘪𝘯 🥃 ' + ` : *${command[0].toUpperCase() + command.substring(1)}*`, null, [['𝙑𝙚𝙧 𝙤𝙩𝙧𝙤 🍹', `${usedPrefix + command}`], [`🔥 ${lenguajeMT.lenguaje() == 'es' ? 'porno chica 2' : 'nsfws girl 2'} 🔥`.toUpperCase(), `${usedPrefix}${lenguajeMT.lenguaje() == 'es' ? temaX[13][1] : temaX[13][2]}`]], fkontak, m)
}else{
await conn.sendFile(m.chat, link, null, `᥀·࣭࣪̇˖🌌◗ 𝙀𝙭𝙤𝙩𝙞𝙘𝙤𝘽𝙤𝙩-𝙈𝘿... ✯✨`, null, null, {viewOnce: true}, m)}}
//await conn.sendButton(m.chat, '『🎉 𝙀𝙭𝙤𝙩𝙞𝙘𝙤𝘽𝙤𝙩-𝙈𝘿 🎉』', `᥀·࣭࣪̇˖🌌◗ 𝙀𝙭𝙤𝙩𝙞𝙘𝙤𝘽𝙤𝙩-𝙈𝘿... ✯✨\n` + ' 🍾 𝘕𝘰 𝘷𝘦𝘢𝘴 𝘦𝘴𝘵𝘢𝘴 𝘤𝘰𝘴𝘢𝘴 𝘱𝘢𝘫𝘪𝘯 🥃 ' + ` : *${command[0].toUpperCase() + command.substring(1)}*`, link, [['𝙑𝙚𝙧 𝙤𝙩𝙧𝙤 🍹', `${usedPrefix + command}`], [`🔥 ${lenguajeMT.lenguaje() == 'es' ? 'porno chica 2' : 'nsfws girl 2'} 🔥`.toUpperCase(), `${usedPrefix}${lenguajeMT.lenguaje() == 'es' ? temaX[13][1] : temaX[13][2]}`]], m, frep)}}
...
if (link.slice(-3) == 'gif') {
let stickerr = await sticker(false, link, global.packname, global.author)
await conn.sendFile(m.chat, stickerr, 'sticker.webp', '', m, true, { contextInfo: { 'forwardingScore': 200, 'isForwarded': false, externalAdReply:{ showAdAttribution: false, title: '『🎉 𝙀𝙭𝙤𝙩𝙞𝙘𝙤𝘽𝙤𝙩-𝙈𝘿 🎉』', body: ' 🍾 𝘕𝘰 𝘷𝘦𝘢𝘴 𝘦𝘴𝘵𝘢𝘴 𝘤𝘰𝘴𝘢𝘴 𝘱𝘢𝘫𝘪𝘯 🥃 ', mediaType: 2, sourceUrl: exoticoAll.getRandom(), thumbnail: await(await fetch(img16)).buffer()}}}, { quoted: m })
await conn.sendButton(m.chat, '『🎉 𝙀𝙭𝙤𝙩𝙞𝙘𝙤𝘽𝙤𝙩-𝙈𝘿 🎉』', `᥀·࣭࣪̇˖🌌◗ 𝙀𝙭𝙤𝙩𝙞𝙘𝙤𝘽𝙤𝙩-𝙈𝘿... ✯✨\n` + ' 🍾 𝘕𝘰 𝘷𝘦𝘢𝘴 𝘦𝘴𝘵𝘢𝘴 𝘤𝘰𝘴𝘢𝘴 𝘱𝘢𝘫𝘪𝘯 🥃 ' + ` : *${command[0].toUpperCase() + command.substring(1)}*`, null, [['𝙑𝙚𝙧 𝙤𝙩𝙧𝙤 🍹', `${usedPrefix + command}`], [`🔥 ${lenguajeMT.lenguaje() == 'es' ? 'porno ass 2' : 'nsfw ass 2'} 🔥`.toUpperCase(), `${usedPrefix}${lenguajeMT.lenguaje() == 'es' ? temaX[1][1] : temaX[1][2]}`]], fkontak, m)
}else{
await conn.sendFile(m.chat, link, null, `᥀·࣭࣪̇˖🌌◗ 𝙀𝙭𝙤𝙩𝙞𝙘𝙤𝘽𝙤𝙩-𝙈𝘿... ✯✨`, null, null, {viewOnce: true}, m)}}
//await conn.sendButton(m.chat, '『🎉 𝙀𝙭𝙤𝙩𝙞𝙘𝙤𝘽𝙤𝙩-𝙈𝘿 🎉』', `᥀·࣭࣪̇˖🌌◗ 𝙀𝙭𝙤𝙩𝙞𝙘𝙤𝘽𝙤𝙩-𝙈𝘿... ✯✨\n` + ' 🍾 𝘕𝘰 𝘷𝘦𝘢𝘴 𝘦𝘴𝘵𝘢𝘴 𝘤𝘰𝘴𝘢𝘴 𝘱𝘢𝘫𝘪𝘯 🥃 ' + ` : *${command[0].toUpperCase() + command.substring(1)}*`, link, [['𝙑𝙚𝙧 𝙤𝙩𝙧𝙤 🍹', `${usedPrefix + command}`], [`🔥 ${lenguajeMT.lenguaje() == 'es' ? 'porno ass 2' : 'nsfw ass 2'} 🔥`.toUpperCase(), `${usedPrefix}${lenguajeMT.lenguaje() == 'es' ? temaX[1][2] : temaX[1][2]}`]], m, frep)}}
...
let stickerr = await sticker(false, link, global.packname, global.author)
await conn.sendFile(m.chat, stickerr, 'sticker.webp', '', m, true, { contextInfo: { 'forwardingScore': 200, 'isForwarded': false, externalAdReply:{ showAdAttribution: false, title: '『🎉 𝙀𝙭𝙤𝙩𝙞𝙘𝙤𝘽𝙤𝙩-𝙈𝘿 🎉』', body: ' 🍾 𝘕𝘰 𝘷𝘦𝘢𝘴 𝘦𝘴𝘵𝘢𝘴 𝘤𝘰𝘴𝘢𝘴 𝘱𝘢𝘫𝘪𝘯 🥃 ', mediaType: 2, sourceUrl: exoticoAll.getRandom(), thumbnail: await(await fetch(img16)).buffer()}}}, { quoted: m })
await conn.sendButton(m.chat, '『🎉 𝙀𝙭𝙤𝙩𝙞𝙘𝙤𝘽𝙤𝙩-𝙈𝘿 🎉』', `᥀·࣭࣪̇˖🌌◗ 𝙀𝙭𝙤𝙩𝙞𝙘𝙤𝘽𝙤𝙩-𝙈𝘿... ✯✨\n` + ' 🍾 𝘕𝘰 𝘷𝘦𝘢𝘴 𝘦𝘴𝘵𝘢𝘴 𝘤𝘰𝘴𝘢𝘴 𝘱𝘢𝘫𝘪𝘯 🥃 ' + ` : *${command[0].toUpperCase() + command.substring(1)}*`, null, [['𝙑𝙚𝙧 𝙤𝙩𝙧𝙤 🍹', `${usedPrefix + command}`], [`🔥 ${lenguajeMT.lenguaje() == 'es' ? 'porno tetas' : 'nsfw boobs'} 🔥`.toUpperCase(), `${usedPrefix}${lenguajeMT.lenguaje() == 'es' ? 'pornotetas' : 'nsfwboobs'}`]], fkontak, m)
}else{
await conn.sendFile(m.chat, link, null, `᥀·࣭࣪̇˖🌌◗ 𝙀𝙭𝙤𝙩𝙞𝙘𝙤𝘽𝙤𝙩-𝙈𝘿... ✯✨`, null, null, {viewOnce: true}, m)}}
...
let stickerr = await sticker(false, link, global.packname, global.author)
await conn.sendFile(m.chat, stickerr, 'sticker.webp', '', m, true, { contextInfo: { 'forwardingScore': 200, 'isForwarded': false, externalAdReply:{ showAdAttribution: false, title: '『🎉 𝙀𝙭𝙤𝙩𝙞𝙘𝙤𝘽𝙤𝙩-𝙈𝘿 🎉』', body: ' 🍾 𝘕𝘰 𝘷𝘦𝘢𝘴 𝘦𝘴𝘵𝘢𝘴 𝘤𝘰𝘴𝘢𝘴 𝘱𝘢𝘫𝘪𝘯 🥃 ', mediaType: 2, sourceUrl: exoticoAll.getRandom(), thumbnail: await(await fetch(img16)).buffer()}}}, { quoted: m })
await conn.sendButton(m.chat, '『🎉 𝙀𝙭𝙤𝙩𝙞𝙘𝙤𝘽𝙤𝙩-𝙈𝘿 🎉』', `᥀·࣭࣪̇˖🌌◗ 𝙀𝙭𝙤𝙩𝙞𝙘𝙤𝘽𝙤𝙩-𝙈𝘿... ✯✨\n` + ' 🍾 𝘕𝘰 𝘷𝘦𝘢𝘴 𝘦𝘴𝘵𝘢𝘴 𝘤𝘰𝘴𝘢𝘴 𝘱𝘢𝘫𝘪𝘯 🥃 ' + ` : *${command[0].toUpperCase() + command.substring(1)}*`, null, [['𝙑𝙚𝙧 𝙤𝙩𝙧𝙤 🍹', `${usedPrefix + command}`], [`🔥 ${lenguajeMT.lenguaje() == 'es' ? 'porno tetas 2' : 'nsfw boobs 2'} 🔥`.toUpperCase(), `${usedPrefix}${lenguajeMT.lenguaje() == 'es' ? temaX[5][1] : temaX[5][2]}`]], fkontak, m)
}else{
await conn.sendFile(m.chat, link, null, `᥀·࣭࣪̇˖🌌◗ 𝙀𝙭𝙤𝙩𝙞𝙘𝙤𝘽𝙤𝙩-𝙈𝘿... ✯✨`, null, null, {viewOnce: true}, m)}}
//await conn.sendButton(m.chat, '『🎉 𝙀𝙭𝙤𝙩𝙞𝙘𝙤𝘽𝙤𝙩-𝙈𝘿 🎉』', `᥀·࣭࣪̇˖🌌◗ 𝙀𝙭𝙤𝙩𝙞𝙘𝙤𝘽𝙤𝙩-𝙈𝘿... ✯✨\n` + ' 🍾 𝘕𝘰 𝘷𝘦𝘢𝘴 𝘦𝘴𝘵𝘢𝘴 𝘤𝘰𝘴𝘢𝘴 𝘱𝘢𝘫𝘪𝘯 🥃 ' + ` : *${command[0].toUpperCase() + command.substring(1)}*`, link, [['𝙑𝙚𝙧 𝙤𝙩𝙧𝙤 🍹', `${usedPrefix + command}`], [`🔥 ${lenguajeMT.lenguaje() == 'es' ? 'porno tetas 2' : 'nsfw boobs 2'} 🔥`.toUpperCase(), `${usedPrefix}${lenguajeMT.lenguaje() == 'es' ? temaX[5][1] : temaX[5][2]}`]], m, frep)}}
...
let stickerr = await sticker(false, link, global.packname, global.author)
await conn.sendFile(m.chat, stickerr, 'sticker.webp', '', m, true, { contextInfo: { 'forwardingScore': 200, 'isForwarded': false, externalAdReply:{ showAdAttribution: false, title: '『🎉 𝙀𝙭𝙤𝙩𝙞𝙘𝙤𝘽𝙤𝙩-𝙈𝘿 🎉』', body: ' 🍾 𝘕𝘰 𝘷𝘦𝘢𝘴 𝘦𝘴𝘵𝘢𝘴 𝘤𝘰𝘴𝘢𝘴 𝘱𝘢𝘫𝘪𝘯 🥃 ', mediaType: 2, sourceUrl: exoticoAll.getRandom(), thumbnail: await(await fetch(img16)).buffer()}}}, { quoted: m })
await conn.sendButton(m.chat, '『🎉 𝙀𝙭𝙤𝙩𝙞𝙘𝙤𝘽𝙤𝙩-𝙈𝘿 🎉』', `᥀·࣭࣪̇˖🌌◗ 𝙀𝙭𝙤𝙩𝙞𝙘𝙤𝘽𝙤𝙩-𝙈𝘿... ✯✨\n` + ' 🍾 𝘕𝘰 𝘷𝘦𝘢𝘴 𝘦𝘴𝘵𝘢𝘴 𝘤𝘰𝘴𝘢𝘴 𝘱𝘢𝘫𝘪𝘯 🥃 ' + ` : *${command[0].toUpperCase() + command.substring(1)}*`, null, [['𝙑𝙚𝙧 𝙤𝙩𝙧𝙤 🍹', `${usedPrefix + command}`], [`🔥 ${lenguajeMT.lenguaje() == 'es' ? 'porno pussy 2' : 'nsfw pussy 2'} 🔥`.toUpperCase(), `${usedPrefix}${lenguajeMT.lenguaje() == 'es' ? temaX[29][1] : temaX[29][2]}`]], fkontak, m)
}else{
await conn.sendFile(m.chat, link, null, `᥀·࣭࣪̇˖🌌◗ 𝙀𝙭𝙤𝙩𝙞𝙘𝙤𝘽𝙤𝙩-𝙈𝘿... ✯✨`, null, null, {viewOnce: true}, m)}}
//await conn.sendButton(m.chat, '『🎉 𝙀𝙭𝙤𝙩𝙞𝙘𝙤𝘽𝙤𝙩-𝙈𝘿 🎉』', `᥀·࣭࣪̇˖🌌◗ 𝙀𝙭𝙤𝙩𝙞𝙘𝙤𝘽𝙤𝙩-𝙈𝘿... ✯✨\n` + ' 🍾 𝘕𝘰 𝘷𝘦𝘢𝘴 𝘦𝘴𝘵𝘢𝘴 𝘤𝘰𝘴𝘢𝘴 𝘱𝘢𝘫𝘪𝘯 🥃 ' + ` : *${command[0].toUpperCase() + command.substring(1)}*`, link, [['𝙑𝙚𝙧 𝙤𝙩𝙧𝙤 🍹', `${usedPrefix + command}`], [`🔥 ${lenguajeMT.lenguaje() == 'es' ? 'porno pussy 2' : 'nsfw pussy 2'} 🔥`.toUpperCase(), `${usedPrefix}${lenguajeMT.lenguaje() == 'es' ? temaX[29][1] : temaX[29][2]}`]], m, frep)}}
...
let stickerr = await sticker(false, link, global.packname, global.author)
await conn.sendFile(m.chat, stickerr, 'sticker.webp', '', m, true, { contextInfo: { 'forwardingScore': 200, 'isForwarded': false, externalAdReply:{ showAdAttribution: false, title: '『🎉 𝙀𝙭𝙤𝙩𝙞𝙘𝙤𝘽𝙤𝙩-𝙈𝘿 🎉』', body: ' 🍾 𝘕𝘰 𝘷𝘦𝘢𝘴 𝘦𝘴𝘵𝘢𝘴 𝘤𝘰𝘴𝘢𝘴 𝘱𝘢𝘫𝘪𝘯 🥃 ', mediaType: 2, sourceUrl: exoticoAll.getRandom(), thumbnail: await(await fetch(img16)).buffer()}}}, { quoted: m })
await conn.sendButton(m.chat, '『🎉 𝙀𝙭𝙤𝙩𝙞𝙘𝙤𝘽𝙤𝙩-𝙈𝘿 🎉』', `᥀·࣭࣪̇˖🌌◗ 𝙀𝙭𝙤𝙩𝙞𝙘𝙤𝘽𝙤𝙩-𝙈𝘿... ✯✨\n` + ' 🍾 𝘕𝘰 𝘷𝘦𝘢𝘴 𝘦𝘴𝘵𝘢𝘴 𝘤𝘰𝘴𝘢𝘴 𝘱𝘢𝘫𝘪𝘯 🥃 ' + ` : *${command[0].toUpperCase() + command.substring(1)}*`, null, [['𝙑𝙚𝙧 𝙤𝙩𝙧𝙤 🍹', `${usedPrefix + command}`], [`🔥 ${lenguajeMT.lenguaje() == 'es' ? 'porno neko 2' : 'nsfw neko 2'} 🔥`.toUpperCase(), `${usedPrefix}${lenguajeMT.lenguaje() == 'es' ? temaX[28][1] : temaX[28][2]}`]], fkontak, m)
}else{
await conn.sendFile(m.chat, link, null, `᥀·࣭࣪̇˖🌌◗ 𝙀𝙭𝙤𝙩𝙞𝙘𝙤𝘽𝙤𝙩-𝙈𝘿... ✯✨`, null, null, {viewOnce: true}, m)}}
//await conn.sendButton(m.chat, '『🎉 𝙀𝙭𝙤𝙩𝙞𝙘𝙤𝘽𝙤𝙩-𝙈𝘿 🎉』', `᥀·࣭࣪̇˖🌌◗ 𝙀𝙭𝙤𝙩𝙞𝙘𝙤𝘽𝙤𝙩-𝙈𝘿... ✯✨\n` + ' 🍾 𝘕𝘰 𝘷𝘦𝘢𝘴 𝘦𝘴𝘵𝘢𝘴 𝘤𝘰𝘴𝘢𝘴 𝘱𝘢𝘫𝘪𝘯 🥃 ' + ` : *${command[0].toUpperCase() + command.substring(1)}*`, link, [['𝙑𝙚𝙧 𝙤𝙩𝙧𝙤 🍹', `${usedPrefix + command}`], [`🔥 ${lenguajeMT.lenguaje() == 'es' ? 'porno neko 2' : 'nsfw neko 2'} 🔥`.toUpperCase(), `${usedPrefix}${lenguajeMT.lenguaje() == 'es' ? temaX[28][1] : temaX[28][2]}`]], m, frep)}}
...
let stickerr = await sticker(false, link, global.packname, global.author)
await conn.sendFile(m.chat, stickerr, 'sticker.webp', '', m, true, { contextInfo: { 'forwardingScore': 200, 'isForwarded': false, externalAdReply:{ showAdAttribution: false, title: '『🎉 𝙀𝙭𝙤𝙩𝙞𝙘𝙤𝘽𝙤𝙩-𝙈𝘿 🎉』', body: ' 🍾 𝘕𝘰 𝘷𝘦𝘢𝘴 𝘦𝘴𝘵𝘢𝘴 𝘤𝘰𝘴𝘢𝘴 𝘱𝘢𝘫𝘪𝘯 🥃 ', mediaType: 2, sourceUrl: exoticoAll.getRandom(), thumbnail: await(await fetch(img16)).buffer()}}}, { quoted: m })
await conn.sendButton(m.chat, '『🎉 𝙀𝙭𝙤𝙩𝙞𝙘𝙤𝘽𝙤𝙩-𝙈𝘿 🎉』', `᥀·࣭࣪̇˖🌌◗ 𝙀𝙭𝙤𝙩𝙞𝙘𝙤𝘽𝙤𝙩-𝙈𝘿... ✯✨\n` + ' 🍾 𝘕𝘰 𝘷𝘦𝘢𝘴 𝘦𝘴𝘵𝘢𝘴 𝘤𝘰𝘴𝘢𝘴 𝘱𝘢𝘫𝘪𝘯 🥃 ' + ` : *${command[0].toUpperCase() + command.substring(1)}*`, null, [['𝙑𝙚𝙧 𝙤𝙩𝙧𝙤 🍹', `${usedPrefix + command}`], [`🔥 ${lenguajeMT.lenguaje() == 'es' ? 'porno yuri' : 'nsfw yuri'} 🔥`.toUpperCase(), `${usedPrefix}${lenguajeMT.lenguaje() == 'es' ? 'pornoyuri' : 'nsfwyuri'}`]], fkontak, m)
}else{
await conn.sendFile(m.chat, link, null, `᥀·࣭࣪̇˖🌌◗ 𝙀𝙭𝙤𝙩𝙞𝙘𝙤𝘽𝙤𝙩-𝙈𝘿... ✯✨`, null, null, {viewOnce: true}, m)}}
//await conn.sendButton(m.chat, '『🎉 𝙀𝙭𝙤𝙩𝙞𝙘𝙤𝘽𝙤𝙩-𝙈𝘿 🎉』', `᥀·࣭࣪̇˖🌌◗ 𝙀𝙭𝙤𝙩𝙞𝙘𝙤𝘽𝙤𝙩-𝙈𝘿... ✯✨\n` + ' 🍾 𝘕𝘰 𝘷𝘦𝘢𝘴 𝘦𝘴𝘵𝘢𝘴 𝘤𝘰𝘴𝘢𝘴 𝘱𝘢𝘫𝘪𝘯 🥃 ' + ` : *${command[0].toUpperCase() + command.substring(1)}*`, link, [['𝙑𝙚𝙧 𝙤𝙩𝙧𝙤 🍹', `${usedPrefix + command}`], [`🔥 ${lenguajeMT.lenguaje() == 'es' ? 'porno yuri' : 'nsfw yuri'} 🔥`.toUpperCase(), `${usedPrefix}${lenguajeMT.lenguaje() == 'es' ? 'pornoyuri' : 'nsfwyuri'}`]], m, frep)}}
...
let stickerr = await sticker(false, link, global.packname, global.author)
await conn.sendFile(m.chat, stickerr, 'sticker.webp', '', m, true, { contextInfo: { 'forwardingScore': 200, 'isForwarded': false, externalAdReply:{ showAdAttribution: false, title: '『🎉 𝙀𝙭𝙤𝙩𝙞𝙘𝙤𝘽𝙤𝙩-𝙈𝘿 🎉』', body: ' 🍾 𝘕𝘰 𝘷𝘦𝘢𝘴 𝘦𝘴𝘵𝘢𝘴 𝘤𝘰𝘴𝘢𝘴 𝘱𝘢𝘫𝘪𝘯 🥃 ', mediaType: 2, sourceUrl: exoticoAll.getRandom(), thumbnail: await(await fetch(img16)).buffer()}}}, { quoted: m })
await conn.sendButton(m.chat, '『🎉 𝙀𝙭𝙤𝙩𝙞𝙘𝙤𝘽𝙤𝙩-𝙈𝘿 🎉』', `᥀·࣭࣪̇˖🌌◗ 𝙀𝙭𝙤𝙩𝙞𝙘𝙤𝘽𝙤𝙩-𝙈𝘿... ✯✨\n` + ' 🍾 𝘕𝘰 𝘷𝘦𝘢𝘴 𝘦𝘴𝘵𝘢𝘴 𝘤𝘰𝘴𝘢𝘴 𝘱𝘢𝘫𝘪𝘯 🥃 ' + ` : *${command[0].toUpperCase() + command.substring(1)}*`, null, [['𝙑𝙚𝙧 𝙤𝙩𝙧𝙤 🍹', `${usedPrefix + command}`], [`🔥 ${lenguajeMT.lenguaje() == 'es' ? 'porno chica' : 'nsfws girl'} 🔥`.toUpperCase(), `${usedPrefix}${lenguajeMT.lenguaje() == 'es' ? temaX[3][1] : temaX[3][2]}`]], fkontak, m)
}else{
await conn.sendFile(m.chat, link, null, `᥀·࣭࣪̇˖🌌◗ 𝙀𝙭𝙤𝙩𝙞𝙘𝙤𝘽𝙤𝙩-𝙈𝘿... ✯✨`, null, null, {viewOnce: true}, m)}}
//await conn.sendButton(m.chat, '『🎉 𝙀𝙭𝙤𝙩𝙞𝙘𝙤𝘽𝙤𝙩-𝙈𝘿 🎉』', `᥀·࣭࣪̇˖🌌◗ 𝙀𝙭𝙤𝙩𝙞𝙘𝙤𝘽𝙤𝙩-𝙈𝘿... ✯✨\n` + ' 🍾 𝘕𝘰 𝘷𝘦𝘢𝘴 𝘦𝘴𝘵𝘢𝘴 𝘤𝘰𝘴𝘢𝘴 𝘱𝘢𝘫𝘪𝘯 🥃 ' + ` : *${command[0].toUpperCase() + command.substring(1)}*`, link, [['𝙑𝙚𝙧 𝙤𝙩𝙧𝙤 🍹', `${usedPrefix + command}`], [`🔥 ${lenguajeMT.lenguaje() == 'es' ? 'porno chica' : 'nsfws girl'} 🔥`.toUpperCase(), `${usedPrefix}${lenguajeMT.lenguaje() == 'es' ? temaX[3][1] : temaX[3][2]}`]], m, frep)}}
...
let stickerr = await sticker(false, link, global.packname, global.author)
await conn.sendFile(m.chat, stickerr, 'sticker.webp', '', m, true, { contextInfo: { 'forwardingScore': 200, 'isForwarded': false, externalAdReply:{ showAdAttribution: false, title: '『🎉 𝙀𝙭𝙤𝙩𝙞𝙘𝙤𝘽𝙤𝙩-𝙈𝘿 🎉』', body: ' 🍾 𝘕𝘰 𝘷𝘦𝘢𝘴 𝘦𝘴𝘵𝘢𝘴 𝘤𝘰𝘴𝘢𝘴 𝘱𝘢𝘫𝘪𝘯 🥃 ', mediaType: 2, sourceUrl: exoticoAll.getRandom(), thumbnail: await(await fetch(img16)).buffer()}}}, { quoted: m })
await conn.sendButton(m.chat, '『🎉 𝙀𝙭𝙤𝙩𝙞𝙘𝙤𝘽𝙤𝙩-𝙈𝘿 🎉』', `᥀·࣭࣪̇˖🌌◗ 𝙀𝙭𝙤𝙩𝙞𝙘𝙤𝘽𝙤𝙩-𝙈𝘿... ✯✨\n` + ' 🍾 𝘕𝘰 𝘷𝘦𝘢𝘴 𝘦𝘴𝘵𝘢𝘴 𝘤𝘰𝘴𝘢𝘴 𝘱𝘢𝘫𝘪𝘯 🥃 ' + ` : *${command[0].toUpperCase() + command.substring(1)}*`, null, [['𝙑𝙚𝙧 𝙤𝙩𝙧𝙤 🍹', `${usedPrefix + command}`], [`🔥 ${lenguajeMT.lenguaje() == 'es' ? 'porno anal 2' : 'nsfws anal 2'} 🔥`.toUpperCase(), `${usedPrefix}${lenguajeMT.lenguaje() == 'es' ? temaX[21][1] : temaX[21][2]}`]], fkontak, m)
}else{
await conn.sendFile(m.chat, link, null, `᥀·࣭࣪̇˖🌌◗ 𝙀𝙭𝙤𝙩𝙞𝙘𝙤𝘽𝙤𝙩-𝙈𝘿... ✯✨`, null, null, {viewOnce: true}, m)}}
//await conn.sendButton(m.chat, '『🎉 𝙀𝙭𝙤𝙩𝙞𝙘𝙤𝘽𝙤𝙩-𝙈𝘿 🎉』', `᥀·࣭࣪̇˖🌌◗ 𝙀𝙭𝙤𝙩𝙞𝙘𝙤𝘽𝙤𝙩-𝙈𝘿... ✯✨\n` + ' 🍾 𝘕𝘰 𝘷𝘦𝘢𝘴 𝘦𝘴𝘵𝘢𝘴 𝘤𝘰𝘴𝘢𝘴 𝘱𝘢𝘫𝘪𝘯 🥃 ' + ` : *${command[0].toUpperCase() + command.substring(1)}*`, link, [['𝙑𝙚𝙧 𝙤𝙩𝙧𝙤 🍹', `${usedPrefix + command}`], [`🔥 ${lenguajeMT.lenguaje() == 'es' ? 'porno anal 2' : 'nsfws anal 2'} 🔥`.toUpperCase(), `${usedPrefix}${lenguajeMT.lenguaje() == 'es' ? temaX[21][1] : temaX[21][2]}`]], m, frep)}}
...
let stickerr = await sticker(false, link, global.packname, global.author)
await conn.sendFile(m.chat, stickerr, 'sticker.webp', '', m, true, { contextInfo: { 'forwardingScore': 200, 'isForwarded': false, externalAdReply:{ showAdAttribution: false, title: '『🎉 𝙀𝙭𝙤𝙩𝙞𝙘𝙤𝘽𝙤𝙩-𝙈𝘿 🎉』', body: ' 🍾 𝘕𝘰 𝘷𝘦𝘢𝘴 𝘦𝘴𝘵𝘢𝘴 𝘤𝘰𝘴𝘢𝘴 𝘱𝘢𝘫𝘪𝘯 🥃 ', mediaType: 2, sourceUrl: exoticoAll.getRandom(), thumbnail: await(await fetch(img16)).buffer()}}}, { quoted: m })
await conn.sendButton(m.chat, '『🎉 𝙀𝙭𝙤𝙩𝙞𝙘𝙤𝘽𝙤𝙩-𝙈𝘿 🎉』', `᥀·࣭࣪̇˖🌌◗ 𝙀𝙭𝙤𝙩𝙞𝙘𝙤𝘽𝙤𝙩-𝙈𝘿... ✯✨\n` + ' 🍾 𝘕𝘰 𝘷𝘦𝘢𝘴 𝘦𝘴𝘵𝘢𝘴 𝘤𝘰𝘴𝘢𝘴 𝘱𝘢𝘫𝘪𝘯 🥃 ' + ` : *${command[0].toUpperCase() + command.substring(1)}*`, null, [['𝙑𝙚𝙧 𝙤𝙩𝙧𝙤 🍹', `${usedPrefix + command}`], [`🔥 ${lenguajeMT.lenguaje() == 'es' ? 'porno furro 2' : 'nsfws furry'} 🔥`.toUpperCase(), `${usedPrefix}${lenguajeMT.lenguaje() == 'es' ? 'pornofurro' : 'nsfwafurry'}`]], fkontak, m)
}else{
await conn.sendFile(m.chat, link, null, `᥀·࣭࣪̇˖🌌◗ 𝙀𝙭𝙤𝙩𝙞𝙘𝙤𝘽𝙤𝙩-𝙈𝘿... ✯✨`, null, null, {viewOnce: true}, m)}}
//await conn.sendButton(m.chat, '『🎉 𝙀𝙭𝙤𝙩𝙞𝙘𝙤𝘽𝙤𝙩-𝙈𝘿 🎉』', `᥀·࣭࣪̇˖🌌◗ 𝙀𝙭𝙤𝙩𝙞𝙘𝙤𝘽𝙤𝙩-𝙈𝘿... ✯✨\n` + ' 🍾 𝘕𝘰 𝘷𝘦𝘢𝘴 𝘦𝘴𝘵𝘢𝘴 𝘤𝘰𝘴𝘢𝘴 𝘱𝘢𝘫𝘪𝘯 🥃 ' + ` : *${command[0].toUpperCase() + command.substring(1)}*`, link, [['𝙑𝙚𝙧 𝙤𝙩𝙧𝙤 🍹', `${usedPrefix + command}`], [`🔥 ${lenguajeMT.lenguaje() == 'es' ? 'porno furro 2' : 'nsfws furry'} 🔥`.toUpperCase(), `${usedPrefix}${lenguajeMT.lenguaje() == 'es' ? 'pornofurro' : 'nsfwafurry'}`]], m, frep)}}
...
let stickerr = await sticker(false, link, global.packname, global.author)
await conn.sendFile(m.chat, stickerr, 'sticker.webp', '', m, true, { contextInfo: { 'forwardingScore': 200, 'isForwarded': false, externalAdReply:{ showAdAttribution: false, title: '『🎉 𝙀𝙭𝙤𝙩𝙞𝙘𝙤𝘽𝙤𝙩-𝙈𝘿 🎉』', body: ' 🍾 𝘕𝘰 𝘷𝘦𝘢𝘴 𝘦𝘴𝘵𝘢𝘴 𝘤𝘰𝘴𝘢𝘴 𝘱𝘢𝘫𝘪𝘯 🥃 ', mediaType: 2, sourceUrl: exoticoAll.getRandom(), thumbnail: await(await fetch(img16)).buffer()}}}, { quoted: m })
await conn.sendButton(m.chat, '『🎉 𝙀𝙭𝙤𝙩𝙞𝙘𝙤𝘽𝙤𝙩-𝙈𝘿 🎉』', `᥀·࣭࣪̇˖🌌◗ 𝙀𝙭𝙤𝙩𝙞𝙘𝙤𝘽𝙤𝙩-𝙈𝘿... ✯✨\n` + ' 🍾 𝘕𝘰 𝘷𝘦𝘢𝘴 𝘦𝘴𝘵𝘢𝘴 𝘤𝘰𝘴𝘢𝘴 𝘱𝘢𝘫𝘪𝘯 🥃 ' + ` : *${command[0].toUpperCase() + command.substring(1)}*`, null, [['𝙑𝙚𝙧 𝙤𝙩𝙧𝙤 🍹', `${usedPrefix + command}`], [`🔥 ${lenguajeMT.lenguaje() == 'es' ? 'porno sticker' : 'nsfws sticker'} 🔥`.toUpperCase(), `${usedPrefix}${lenguajeMT.lenguaje() == 'es' ? temaX[2][1] : temaX[2][2]}`]], fkontak, m)
}else{
await conn.sendFile(m.chat, link, null, `᥀·࣭࣪̇˖🌌◗ 𝙀𝙭𝙤𝙩𝙞𝙘𝙤𝘽𝙤𝙩-𝙈𝘿... ✯✨`, null, null, {viewOnce: true}, m)}}
//await conn.sendButton(m.chat, '『🎉 𝙀𝙭𝙤𝙩𝙞𝙘𝙤𝘽𝙤𝙩-𝙈𝘿 🎉』', `᥀·࣭࣪̇˖🌌◗ 𝙀𝙭𝙤𝙩𝙞𝙘𝙤𝘽𝙤𝙩-𝙈𝘿... ✯✨\n` + ' 🍾 𝘕𝘰 𝘷𝘦𝘢𝘴 𝘦𝘴𝘵𝘢𝘴 𝘤𝘰𝘴𝘢𝘴 𝘱𝘢𝘫𝘪𝘯 🥃 ' + ` : *${command[0].toUpperCase() + command.substring(1)}*`, link, [['𝙑𝙚𝙧 𝙤𝙩𝙧𝙤 🍹', `${usedPrefix + command}`], [`🔥 ${lenguajeMT.lenguaje() == 'es' ? 'porno sticker' : 'nsfws sticker'} 🔥`.toUpperCase(), `${usedPrefix}${lenguajeMT.lenguaje() == 'es' ? temaX[2][1] : temaX[2][2]}`]], m, frep)}}
...
await conn.sendFile(m.chat, stickerr, 'sticker.webp', '', m, true, { contextInfo: { 'forwardingScore': 200, 'isForwarded': false, externalAdReply:{ showAdAttribution: false, title: '『🎉 𝙀𝙭𝙤𝙩𝙞𝙘𝙤𝘽𝙤𝙩-𝙈𝘿 🎉』', body: ' 🍾 𝘕𝘰 𝘷𝘦𝘢𝘴 𝘦𝘴𝘵𝘢𝘴 𝘤𝘰𝘴𝘢𝘴 𝘱𝘢𝘫𝘪𝘯 🥃 ', mediaType: 2, sourceUrl: exoticoAll.getRandom(), thumbnail: await(await fetch(img16)).buffer()}}}, { quoted: m })
await conn.sendFile(m.chat, null, null, `᥀·࣭࣪̇˖🌌◗ 𝙀𝙭𝙤𝙩𝙞𝙘𝙤𝘽𝙤𝙩-𝙈𝘿... ✯✨`, null, null, {viewOnce: true}, m)}
//await conn.sendButton(m.chat, '『🎉 𝙀𝙭𝙤𝙩𝙞𝙘𝙤𝘽𝙤𝙩-𝙈𝘿 🎉』', `᥀·࣭࣪̇˖🌌◗ 𝙀𝙭𝙤𝙩𝙞𝙘𝙤𝘽𝙤𝙩-𝙈𝘿... ✯✨\n` + ' 🍾 𝘕𝘰 𝘷𝘦𝘢𝘴 𝘦𝘴𝘵𝘢𝘴 𝘤𝘰𝘴𝘢𝘴 𝘱𝘢𝘫𝘪𝘯 🥃 ' + ` : *${command[0].toUpperCase() + command.substring(1)}*`, null, [['𝙑𝙚𝙧 𝙤𝙩𝙧𝙤 🍹', `${usedPrefix + command}`], [`🔥 ${lenguajeMT.lenguaje() == 'es' ? 'porno anal' : 'nsfws anal'} 🔥`.toUpperCase(), `${usedPrefix}${lenguajeMT.lenguaje() == 'es' ? 'pornoanal' : 'nsfwanal'}`]], fkontak, m)}
...
await conn.sendFile(m.chat, stickerr, 'sticker.webp', '', m, true, { contextInfo: { 'forwardingScore': 200, 'isForwarded': false, externalAdReply:{ showAdAttribution: false, title: '『🎉 𝙀𝙭𝙤𝙩𝙞𝙘𝙤𝘽𝙤𝙩-𝙈𝘿 🎉』', body: ' 🍾 𝘕𝘰 𝘷𝘦𝘢𝘴 𝘦𝘴𝘵𝘢𝘴 𝘤𝘰𝘴𝘢𝘴 𝘱𝘢𝘫𝘪𝘯 🥃 ', mediaType: 2, sourceUrl: exoticoAll.getRandom(), thumbnail: await(await fetch(img16)).buffer()}}}, { quoted: m })
await conn.sendFile(m.chat, null, null, `᥀·࣭࣪̇˖🌌◗ 𝙀𝙭𝙤𝙩𝙞𝙘𝙤𝘽𝙤𝙩-𝙈𝘿... ✯✨`, null, null, {viewOnce: true}, m)}
//await conn.sendButton(m.chat, '『🎉 𝙀𝙭𝙤𝙩𝙞𝙘𝙤𝘽𝙤𝙩-𝙈𝘿 🎉』', `᥀·࣭࣪̇˖🌌◗ 𝙀𝙭𝙤𝙩𝙞𝙘𝙤𝘽𝙤𝙩-𝙈𝘿... ✯✨\n` + ' 🍾 𝘕𝘰 𝘷𝘦𝘢𝘴 𝘦𝘴𝘵𝘢𝘴 𝘤𝘰𝘴𝘢𝘴 𝘱𝘢𝘫𝘪𝘯 🥃 ' + ` : *${command[0].toUpperCase() + command.substring(1)}*`, null, [['𝙑𝙚𝙧 𝙤𝙩𝙧𝙤 🍹', `${usedPrefix + command}`], [`🔥 ${lenguajeMT.lenguaje() == 'es' ? 'porno pussy' : 'nsfw pussy'} 🔥`.toUpperCase(), `${usedPrefix}${lenguajeMT.lenguaje() == 'es' ? 'pornopussy' : 'nsfwpussy'}`]], fkontak, m)}
...
await conn.sendFile(m.chat, stickerr, 'sticker.webp', '', m, true, { contextInfo: { 'forwardingScore': 200, 'isForwarded': false, externalAdReply:{ showAdAttribution: false, title: '『🎉 𝙀𝙭𝙤𝙩𝙞𝙘𝙤𝘽𝙤𝙩-𝙈𝘿 🎉』', body: ' 🍾 𝘕𝘰 𝘷𝘦𝘢𝘴 𝘦𝘴𝘵𝘢𝘴 𝘤𝘰𝘴𝘢𝘴 𝘱𝘢𝘫𝘪𝘯 🥃 ', mediaType: 2, sourceUrl: exoticoAll.getRandom(), thumbnail: await(await fetch(img16)).buffer()}}}, { quoted: m })
await conn.sendFile(m.chat, null, null, `᥀·࣭࣪̇˖🌌◗ 𝙀𝙭𝙤𝙩𝙞𝙘𝙤𝘽𝙤𝙩-𝙈𝘿... ✯✨`, null, null, {viewOnce: true}, m)}
//await conn.sendButton(m.chat, '『🎉 𝙀𝙭𝙤𝙩𝙞𝙘𝙤𝘽𝙤𝙩-𝙈𝘿 🎉』', `᥀·࣭࣪̇˖🌌◗ 𝙀𝙭𝙤𝙩𝙞𝙘𝙤𝘽𝙤𝙩-𝙈𝘿... ✯✨\n` + ' 🍾 𝘕𝘰 𝘷𝘦𝘢𝘴 𝘦𝘴𝘵𝘢𝘴 𝘤𝘰𝘴𝘢𝘴 𝘱𝘢𝘫𝘪𝘯 🥃 ' + ` : *${command[0].toUpperCase() + command.substring(1)}*`, null, [['𝙑𝙚𝙧 𝙤𝙩𝙧𝙤 🍹', `${usedPrefix + command}`], [`🔥 ${lenguajeMT.lenguaje() == 'es' ? 'porno orgia' : 'nsfw orgy'} 🔥`.toUpperCase(), `${usedPrefix}${lenguajeMT.lenguaje() == 'es' ? 'pornorgia' : 'nsfworgy'}`]], fkontak, m)}
...
let stickerr = await sticker(false, link, global.packname, global.author)
await conn.sendFile(m.chat, stickerr, 'sticker.webp', '', m, true, { contextInfo: { 'forwardingScore': 200, 'isForwarded': false, externalAdReply:{ showAdAttribution: false, title: '『🎉 𝙀𝙭𝙤𝙩𝙞𝙘𝙤𝘽𝙤𝙩-𝙈𝘿 🎉』', body: ' 🍾 𝘕𝘰 𝘷𝘦𝘢𝘴 𝘦𝘴𝘵𝘢𝘴 𝘤𝘰𝘴𝘢𝘴 𝘱𝘢𝘫𝘪𝘯 🥃 ', mediaType: 2, sourceUrl: exoticoAll.getRandom(), thumbnail: await(await fetch(img16)).buffer()}}}, { quoted: m })
await conn.sendButton(m.chat, '『🎉 𝙀𝙭𝙤𝙩𝙞𝙘𝙤𝘽𝙤𝙩-𝙈𝘿 🎉』', `᥀·࣭࣪̇˖🌌◗ 𝙀𝙭𝙤𝙩𝙞𝙘𝙤𝘽𝙤𝙩-𝙈𝘿... ✯✨\n` + ' 🍾 𝘕𝘰 𝘷𝘦𝘢𝘴 𝘦𝘴𝘵𝘢𝘴 𝘤𝘰𝘴𝘢𝘴 𝘱𝘢𝘫𝘪𝘯 🥃 ' + ` : *${command[0].toUpperCase() + command.substring(1)}*`, null, [['𝙑𝙚𝙧 𝙤𝙩𝙧𝙤 🍹', `${usedPrefix + command}`], [`🔥 ${lenguajeMT.lenguaje() == 'es' ? 'porno yaoi' : 'nsfw yaoi'} 🔥`.toUpperCase(), `${usedPrefix}${lenguajeMT.lenguaje() == 'es' ? 'pornoyaoi' : 'nsfwyaoi'}`]], fkontak, m)
}else{
await conn.sendFile(m.chat, link, null, `᥀·࣭࣪̇˖🌌◗ 𝙀𝙭𝙤𝙩𝙞𝙘𝙤𝘽𝙤𝙩-𝙈𝘿... ✯✨`, null, null, {viewOnce: true}, m)}}
//await conn.sendButton(m.chat, '『🎉 𝙀𝙭𝙤𝙩𝙞𝙘𝙤𝘽𝙤𝙩-𝙈𝘿 🎉』', `᥀·࣭࣪̇˖🌌◗ 𝙀𝙭𝙤𝙩𝙞𝙘𝙤𝘽𝙤𝙩-𝙈𝘿... ✯✨\n` + ' 🍾 𝘕𝘰 𝘷𝘦𝘢𝘴 𝘦𝘴𝘵𝘢𝘴 𝘤𝘰𝘴𝘢𝘴 𝘱𝘢𝘫𝘪𝘯 🥃 ' + ` : *${command[0].toUpperCase() + command.substring(1)}*`, link, [['𝙑𝙚𝙧 𝙤𝙩𝙧𝙤 🍹', `${usedPrefix + command}`], [`🔥 ${lenguajeMT.lenguaje() == 'es' ? 'porno yaoi' : 'nsfw yaoi'} 🔥`.toUpperCase(), `${usedPrefix}${lenguajeMT.lenguaje() == 'es' ? 'pornoyaoi' : 'nsfwyaoi'}`]], m, frep)}}
...
//Por favor de dar los creditos a GataNina-Li
//no hagan pasar los codigos por suyos...*/