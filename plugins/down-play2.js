...
additionalText = IDexotic.espereAudio
} else if (command == 'playvideodoc' || command == 'ytmp4doc') {
additionalText = IDexotic.espereVideo
}
...
await conn.sendMessage(m.chat, { document: { url: lolh.result.link }, caption: `${IDexotic.botInfo}`, fileName: `${n}.mp3`, mimetype: 'audio/mpeg', contextInfo: {
externalAdReply: {
title: n, 
body: "",
thumbnailUrl: yt_play[0].thumbnail, 
...
await conn.sendMessage(m.chat, { document: { url: dl_url }, caption: `${IDexotic.botInfo}`, fileName: `${ttl}.mp3`, mimetype: 'audio/mpeg', contextInfo: {
externalAdReply: {
title: ttl,
body: "",
thumbnailUrl: yt_play[0].thumbnail, 
...
await conn.sendMessage(m.chat, {document: {url: n2}, fileName: `${n}.mp4`, mimetype: 'video/mp4', caption: `${IDexotic.botInfo}`, thumbnail: await fetch(n4)}, {quoted: m});
handler.limit = 3
} catch {
}}}}
} catch (e) {
