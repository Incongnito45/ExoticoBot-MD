...
await m.reply(`᥀·࣭࣪̇˖✅◗ 𝙀𝙣𝙫𝙞𝙖𝙣𝙙𝙤 𝙗𝙖𝙨𝙚 𝙙𝙚 𝙙𝙖𝙩𝙤𝙨 𝙙𝙚 𝙀𝙭𝙤𝙩𝙞𝙘𝙤𝘽𝙤𝙩-𝙈𝘿...`)
try {
let d = new Date
let date = d.toLocaleDateString('es', { day: 'numeric', month: 'long', year: 'numeric' })
let database = await fs.readFileSync(`./database.json`)
let creds = await fs.readFileSync(`./ExoticoBotSession/creds.json`)
...
console.log(`᥀·࣭࣪̇˖❌◗ 𝙃𝙪𝙗𝙤 𝙪𝙣 𝙚𝙧𝙧𝙤𝙧 𝙖𝙡 𝙚𝙣𝙫𝙞𝙖𝙧 𝙡𝙖 𝙗𝙖𝙨𝙚 𝙙𝙚 𝙙𝙖𝙩𝙤𝙨, 𝙞𝙣𝙩𝙚𝙣𝙩𝙖𝙡𝙤 𝙙𝙚 𝙢𝙪𝙚𝙫𝙤.`)
console.log(e)}}
