...
browser: mcode ? ['Ubuntu', 'Chrome', '110.0.5585.95'] : ['ExoticoBot-MD', 'Opera', '5.0'],
...
console.log('ERROR DESCONOCIDO: ${reason || ""} >> ${connection || ""}')
}}
...
handler.help = [`subbot`]
handler.tags = [`subbot`]
handler.command = /^(subbot|rentbot)/i
