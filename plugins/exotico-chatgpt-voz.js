...
const sistema1 = `Actuaras como un Bot de WhatsApp el cual fue creado por MultiBot-OFC, tu seras ExoticoBot-MD`;
const handler = async (m, {conn, text, usedPrefix, command}) => {
if (usedPrefix == 'a' || usedPrefix == 'A') return;
if (!text) throw `*${IDexotic.ChatGpt} ${usedPrefix + command} Hola, ¿como estas?` 
try {
