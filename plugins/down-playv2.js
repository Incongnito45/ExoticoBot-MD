...
if (!text) throw `᥀·࣭࣪̇˖☁️◗ 𝙄𝙣𝙜𝙧𝙚𝙨𝙚 𝙚𝙡 𝙣𝙤𝙢𝙗𝙧𝙚 𝙙𝙚 𝙡𝙖 𝙘𝙖𝙣𝙘𝙞𝙤𝙣 𝙦𝙪𝙚 𝙚𝙨𝙩𝙖 𝙗𝙪𝙨𝙘𝙖𝙣𝙙𝙤.\n\n• 𝙋𝙤𝙧 𝙚𝙟𝙚𝙢𝙥𝙡𝙤:\n*${usedPrefix + command} Erika lundmoen - yad*`
try {
if (command == 'play.1') {
conn.reply(m.chat, '᥀·࣭࣪̇˖☄️◗ 𝘿𝙚𝙨𝙘𝙖𝙧𝙜𝙖𝙣𝙙𝙤 𝙚𝙡 𝙖𝙪𝙙𝙞𝙤...', m, { contextInfo: { externalAdReply :{ mediaUrl: null, mediaType: 1, description: null, title: '᥀·࣭࣪̇˖☁️◗ 𝘋𝘌𝘚𝘊𝘈𝘙𝘎𝘈𝘋𝘖𝘙 𝘋𝘌 𝘈𝘜𝘋𝘐𝘖𝘚... 🍷', body: botInfo, previewType: 0, thumbnail: imagenRB, sourceUrl: exoticoAll }}}) 
try { 
...
if (command == 'play.2') {
conn.reply(m.chat, '᥀·࣭࣪̇˖☁️◗ 𝘿𝙚𝙨𝙘𝙖𝙧𝙜𝙖𝙣𝙙𝙤 𝙚𝙡 𝙫𝙞𝙙𝙚𝙤...', m, {contextInfo: { externalAdReply :{ mediaUrl: null, mediaType: 1, description: null, title: '᥀·࣭࣪̇˖☁️◗ 𝘋𝘌𝘚𝘊𝘈𝘙𝘎𝘈𝘋𝘖𝘙 𝘋𝘌 𝘝𝘐𝘋𝘌𝘖𝘚... 🍷', body: botInfo, previewType: 0, thumbnail: imagenRB, sourceUrl: exoticoAll }}}) 
try {
