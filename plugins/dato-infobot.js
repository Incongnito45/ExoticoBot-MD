...
['Grupo', '#grupolista'], ['Cuentas', '/cuentasxb'], ['Menu', '.menu']], null, [ ['Canal', `${mycanal}`]], fkontak)}
handler.help = ['infobot']
handler.tags = ['info', 'tools']
handler.command = /^(infobot|informacionbot|infoexotic|informaciónexotic|informacionexotic)$/i
