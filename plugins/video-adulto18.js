...
await conn.sendFile(m.chat, enlace, null, `${IDexotic.pornPrem}\n${IDexotic.Premium} • ${user.premiumTime > 0 ? IDexotic.Si : IDexotic.No}`, m, null, {viewOnce: true})
break
case "pornovid2": case "nsfwvid2":    
await conn.sendFile(m.chat, enlace1, null, `${IDexotic.pornPrem}\n${IDexotic.Premium} • ${user.premiumTime > 0 ? IDexotic.Si : IDexotic.No}`, m, null, {viewOnce: true})
break 
case "pornovidlesbi": case "nsfwvidlesbi":       
await conn.sendFile(m.chat, enlace2, null, `${IDexotic.pornPrem}\n${IDexotic.Premium} • ${user.premiumTime > 0 ? IDexotic.Si : IDexotic.No}`, m, null, {viewOnce: true})
break
case "pornovidgay": case "nsfwvidgay":       
await conn.sendFile(m.chat, enlace3, null, `${IDexotic.pornPrem}\n${IDexotic.Premium} • ${user.premiumTime > 0 ? IDexotic.Si : IDexotic.No}`, m, null, {viewOnce: true})
break 
case "pornovidbisexual": case "nsfwvidbisexual":       
await conn.sendFile(m.chat, enlace4, null, `${IDexotic.pornPrem}\n${IDexotic.Premium} • ${user.premiumTime > 0 ? IDexotic.Si : IDexotic.No}`, m, null, {viewOnce: true})
break 
case "pornovidrandom": case "nsfwvidrandom":       
await conn.sendFile(m.chat, enlace5, null, `${IDexotic.pornPrem}\n${IDexotic.Premium} • ${user.premiumTime > 0 ? IDexotic.Si : IDexotic.No}`, m, null, {viewOnce: true})
break 
