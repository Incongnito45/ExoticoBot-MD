...
if (!db.data.chats[m.chat].modohorny && m.isGroup) throw `᥀·࣭࣪̇˖🍁◗ 𝙇𝙤𝙨 𝙘𝙤𝙢𝙖𝙣𝙙𝙤𝙨 𝙥𝙖𝙧𝙖 𝙖𝙙𝙪𝙡𝙩𝙤 𝙚𝙨𝙩𝙖𝙣 𝙙𝙚𝙨𝙖𝙘𝙩𝙞𝙫𝙖𝙙𝙤𝙨, 𝙪𝙨𝙚 𝙚𝙡 𝙘𝙤𝙢𝙖𝙣𝙙𝙤: #on modohorny`
try{ 
switch (command) {  
case "pornovid": case "nsfwvid":    
await conn.sendFile(m.chat, enlace, null, `᥀·࣭࣪̇˖🌌◗ 𝙀𝙭𝙤𝙩𝙞𝙘𝙤𝘽𝙤𝙩-𝙈𝘿... ✯✨`, m, null, {viewOnce: true})
break
case "pornovid2": case "nsfwvid2":    
await conn.sendFile(m.chat, enlace1, null, `᥀·࣭࣪̇˖🌌◗ 𝙀𝙭𝙤𝙩𝙞𝙘𝙤𝘽𝙤𝙩-𝙈𝘿... ✯✨`, m, null, {viewOnce: true})
break 
case "pornovidlesbi": case "nsfwvidlesbi":       
await conn.sendFile(m.chat, enlace2, null, `᥀·࣭࣪̇˖🌌◗ 𝙀𝙭𝙤𝙩𝙞𝙘𝙤𝘽𝙤𝙩-𝙈𝘿... ✯✨`, m, null, {viewOnce: true})
break
case "pornovidgay": case "nsfwvidgay":       
await conn.sendFile(m.chat, enlace3, null, `᥀·࣭࣪̇˖🌌◗ 𝙀𝙭𝙤𝙩𝙞𝙘𝙤𝘽𝙤𝙩-𝙈𝘿... ✯✨`, m, null, {viewOnce: true})
break 
case "pornovidbisexual": case "nsfwvidbisexual":       
await conn.sendFile(m.chat, enlace4, null, `᥀·࣭࣪̇˖🌌◗ 𝙀𝙭𝙤𝙩𝙞𝙘𝙤𝘽𝙤𝙩-𝙈𝘿... ✯✨`, m, null, {viewOnce: true})
break 
case "pornovidrandom": case "nsfwvidrandom":       
await conn.sendFile(m.chat, enlace5, null, `᥀·࣭࣪̇˖🌌◗ 𝙀𝙭𝙤𝙩𝙞𝙘𝙤𝘽𝙤𝙩-𝙈𝘿... ✯✨`, m, null, {viewOnce: true})
break 
