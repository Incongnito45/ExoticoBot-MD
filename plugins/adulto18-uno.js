...
let res = (await axios.get(`https://raw.githubusercontent.com/MultiBot-OFC/ExoticoBot-MD/master/JSON/nsfwloli.json`)).data  
let enlace = await res[Math.floor(res.length * Math.random())]  
await conn.sendFile(m.chat, enlace, null, `${IDexotic.Premium} •  ${user.premiumTime > 0 ? IDexotic.Si : IDexotic.No}`, null, null, {viewOnce: true}, m)}
  
if (command == 'pornopies' || command == 'nsfwfoot') {
let res = (await axios.get(`https://raw.githubusercontent.com/MultiBot-OFC/ExoticoBot-MD/master/JSON/nsfwfoot.json`)).data  
let enlace = await res[Math.floor(res.length * Math.random())]  
await conn.sendFile(m.chat, enlace, null, `${IDexotic.Premium} •  ${user.premiumTime > 0 ? IDexotic.Si : IDexotic.No}`, null, null, {viewOnce: true}, m)}
  
if (command == 'pornoass' || command == 'nsfwass') {
let res = (await axios.get(`https://raw.githubusercontent.com/MultiBot-OFC/ExoticoBot-MD/master/JSON/nsfwass.json`)).data  
let enlace = await res[Math.floor(res.length * Math.random())]  
await conn.sendFile(m.chat, enlace, null, `${IDexotic.Premium} •  ${user.premiumTime > 0 ? IDexotic.Si : IDexotic.No}`, null, null, {viewOnce: true}, m)}
  
if (command == 'pornobdsm' || command == 'nsfwbdsm') {
let res = (await axios.get(`https://raw.githubusercontent.com/MultiBot-OFC/ExoticoBot-MD/master/JSON/nsfwbdsm.json`)).data  
let enlace = await res[Math.floor(res.length * Math.random())]  
await conn.sendFile(m.chat, enlace, null, `${IDexotic.Premium} •  ${user.premiumTime > 0 ? IDexotic.Si : IDexotic.No}`, null, null, {viewOnce: true}, m)}
  
if (command == 'pornocum' || command == 'nsfwcum') {
let res = (await axios.get(`https://raw.githubusercontent.com/MultiBot-OFC/ExoticoBot-MD/master/JSON/nsfwcum.json`)).data  
let enlace = await res[Math.floor(res.length * Math.random())]  
await conn.sendFile(m.chat, enlace, null, `${IDexotic.Premium} •  ${user.premiumTime > 0 ? IDexotic.Si : IDexotic.No}`, null, null, {viewOnce: true}, m)}
  
if (command == 'pornoero' || command == 'nsfwero') {
let res = (await axios.get(`https://raw.githubusercontent.com/MultiBot-OFC/ExoticoBot-MD/master/JSON/nsfwero.json`)).data  
let enlace = await res[Math.floor(res.length * Math.random())]  
await conn.sendFile(m.chat, enlace, null, `${IDexotic.Premium} •  ${user.premiumTime > 0 ? IDexotic.Si : IDexotic.No}`, null, null, {viewOnce: true}, m)}
 
if (command == 'pornodominar' || command == 'nsfwfemdom') {
let res = (await axios.get(`https://raw.githubusercontent.com/MultiBot-OFC/ExoticoBot-MD/master/JSON/nsfwfemdom.json`)).data  
let enlace = await res[Math.floor(res.length * Math.random())]  
await conn.sendFile(m.chat, enlace, null, `${IDexotic.Premium} •  ${user.premiumTime > 0 ? IDexotic.Si : IDexotic.No}`, null, null, {viewOnce: true}, m)}
 
if (command == 'pornoglass' || command == 'nsfwglass') {
let res = (await axios.get(`https://raw.githubusercontent.com/MultiBot-OFC/ExoticoBot-MD/master/JSON/nsfwglass.json`)).data  
let enlace = await res[Math.floor(res.length * Math.random())]  
await conn.sendFile(m.chat, enlace, null, `${IDexotic.Premium} •  ${user.premiumTime > 0 ? IDexotic.Si : IDexotic.No}`, null, null, {viewOnce: true}, m)}
  
if (command == 'pornohentai' || command == 'nsfwhentai') {
let res = (await axios.get(`https://raw.githubusercontent.com/MultiBot-OFC/ExoticoBot-MD/master/JSON/hentai.json`)).data  
let enlace = await res[Math.floor(res.length * Math.random())]  
await conn.sendFile(m.chat, enlace, null, `${IDexotic.Premium} •  ${user.premiumTime > 0 ? IDexotic.Si : IDexotic.No}`, null, null, {viewOnce: true}, m)}
 
if (command == 'pornorgia' || command == 'nsfworgy') {
let res = (await axios.get(`https://raw.githubusercontent.com/MultiBot-OFC/ExoticoBot-MD/master/JSON/nsfworgy.json`)).data  
let enlace = await res[Math.floor(res.length * Math.random())]
await conn.sendFile(m.chat, enlace, null, `${IDexotic.Premium} •  ${user.premiumTime > 0 ? IDexotic.Si : IDexotic.No}`, null, null, {viewOnce: true}, m)}
 
if (command == 'pornotetas' || command == 'nsfwboobs') {
let resError = (await axios.get(`https://raw.githubusercontent.com/MultiBot-OFC/ExoticoBot-MD/master/JSON/tetas.json`)).data   
let res = await conn.getFile(`https://api-fgmods.ddns.net/api/nsfw/boobs?apikey=fg-dylux`).data
if (res == '' || !res || res == null) res = await resError[Math.floor(resError.length * Math.random())]  
await conn.sendFile(m.chat, res, null, `${IDexotic.Premium} •  ${user.premiumTime > 0 ? IDexotic.Si : IDexotic.No}`, null, null, {viewOnce: true}, m)}
 
if (command == 'pornobooty' || command == 'nsfwbooty') {
let resError = (await axios.get(`https://raw.githubusercontent.com/MultiBot-OFC/ExoticoBot-MD/master/JSON/booty.json`)).data   
...
let res = (await axios.get(`https://raw.githubusercontent.com/MultiBot-OFC/ExoticoBot-MD/master/JSON/ecchi.json`)).data  
let enlace = await res[Math.floor(res.length * Math.random())]
await conn.sendFile(m.chat, enlace, null, `${IDexotic.Premium} •  ${user.premiumTime > 0 ? IDexotic.Si : IDexotic.No}`, null, null, {viewOnce: true}, m)}
  
if (command == 'pornofurro' || command == 'nsfwfurry') {
let res = (await axios.get(`https://raw.githubusercontent.com/MultiBot-OFC/ExoticoBot-MD/master/JSON/furro.json`)).data  
let enlace = await res[Math.floor(res.length * Math.random())]
await conn.sendFile(m.chat, enlace, null, `${IDexotic.Premium} •  ${user.premiumTime > 0 ? IDexotic.Si : IDexotic.No}`, null, null, {viewOnce: true}, m)}
...
let resError = (await axios.get(`https://raw.githubusercontent.com/MultiBot-OFC/ExoticoBot-MD/master/JSON/imagenlesbians.json`)).data   
...
let res = (await axios.get(`https://raw.githubusercontent.com/MultiBot-OFC/ExoticoBot-MD/master/JSON/panties.json`)).data  
let enlace = await res[Math.floor(res.length * Math.random())]
await conn.sendFile(m.chat, enlace, null, `${IDexotic.Premium} •  ${user.premiumTime > 0 ? IDexotic.Si : IDexotic.No}`, null, null, {viewOnce: true}, m)}
 
if (command == 'pornopene' || command == 'nsfwpenis') {
let resError = (await axios.get(`https://raw.githubusercontent.com/MultiBot-OFC/ExoticoBot-MD/master/JSON/pene.json`)).data   
let res = await conn.getFile(`https://api-fgmods.ddns.net/api/nsfw/penis?apikey=fg-dylux`).data
if (res == '' || !res || res == null) res = await resError[Math.floor(resError.length * Math.random())]  
await conn.sendFile(m.chat, res, null, `${IDexotic.Premium} •  ${user.premiumTime > 0 ? IDexotic.Si : IDexotic.No}`, null, null, {viewOnce: true}, m)}
  
if (command == 'porno' || command == 'porn') {
let res = (await axios.get(`https://raw.githubusercontent.com/MultiBot-OFC/ExoticoBot-MD/master/JSON/porno.json`)).data  
let enlace = await res[Math.floor(res.length * Math.random())]
await conn.sendFile(m.chat, res, null, `${IDexotic.Premium} •  ${user.premiumTime > 0 ? IDexotic.Si : IDexotic.No}`, null, null, {viewOnce: true}, m)}

if (command == 'pornorandom' || command == 'pornrandom') {
let rawjsonn = ['https://raw.githubusercontent.com/MultiBot-OFC/ExoticoBot-MD/master/JSON/tetas.json', 'https://raw.githubusercontent.com/MultiBot-OFC/ExoticoBot-MD/master/JSON/booty.json', 'https://raw.githubusercontent.com/MultiBot-OFC/ExoticoBot-MD/master/JSON/imagenlesbians.json', 'https://raw.githubusercontent.com/MultiBot-OFC/ExoticoBot-MD/master/JSON/panties.json', 'https://raw.githubusercontent.com/MultiBot-OFC/ExoticoBot-MD/master/JSON/porno.json'] 
...
let res = (await axios.get(`https://raw.githubusercontent.com/MultiBot-OFC/ExoticoBot-MD/master/JSON/pechos.json`)).data  
let enlace = await res[Math.floor(res.length * Math.random())]
await conn.sendFile(m.chat, enlace, null, `${IDexotic.Premium} •  ${user.premiumTime > 0 ? IDexotic.Si : IDexotic.No}`, null, null, {viewOnce: true}, m)}
 
if (command == 'pornoyaoi' || command == 'nsfwyaoi') {
let res = (await axios.get(`https://raw.githubusercontent.com/HasamiAini/wabot_takagisan/main/whatsapp%20bot%20takagisan/whatsapp%20bot%20takagisan/lib/Yaoi.json`)).data  //`https://raw.githubusercontent.com/MultiBot-OFC/ExoticoBot-MD/master/JSON/yaoi.json`
let enlace = await res[Math.floor(res.length * Math.random())]
...
let res = (await axios.get(`https://raw.githubusercontent.com/MultiBot-OFC/ExoticoBot-MD/master/JSON/yuri.json`)).data  
let enlace = await res[Math.floor(res.length * Math.random())]  
await conn.sendFile(m.chat, enlace, null, `${IDexotic.Premium} •  ${user.premiumTime > 0 ? IDexotic.Si : IDexotic.No}`, null, null, {viewOnce: true}, m)}
