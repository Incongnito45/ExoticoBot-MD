//Codigo de GataNina-Li • Dar los creditos a ella por favor.
...
let frep = { contextInfo: { externalAdReply: {title: wm, body: '𝘾𝙤𝙣𝙩𝙚𝙣𝙞𝙙𝙤𝙨', sourceUrl: imagenRB.getRandom(), thumbnail: await(await fetch(img16)).buffer() }}}
let user = global.db.data.users[m.sender]

if (!db.data.chats[m.chat].modohorny && m.isGroup) throw `᥀·࣭࣪̇˖🛡️◗ 𝙀𝙨𝙩𝙚 𝙘𝙤𝙢𝙖𝙣𝙙𝙤 𝙚𝙨𝙩𝙖𝙣 𝙙𝙚𝙨𝙖𝙘𝙩𝙞𝙫𝙖𝙙𝙤𝙨, 𝙥𝙪𝙚𝙙𝙚𝙨 𝙖𝙘𝙩𝙞𝙫𝙖𝙧𝙡𝙤𝙨 𝙪𝙨𝙖𝙣𝙙𝙤 𝙚𝙡 𝙘𝙤𝙢𝙖𝙣𝙙𝙤: #on modohorny` 
try{  
if (command == 'pornololi' || command == 'nsfwloli') {
let res = (await axios.get(`https://raw.githubusercontent.com/MultiBot-OFC/ExoticoBot-MD/master/NODE_EXOTICO_JSON/node-exotico-anime/nsfwloli.json`)).data  
let enlace = await res[Math.floor(res.length * Math.random())]  
await conn.sendFile(m.chat, enlace, null, `᥀·࣭࣪̇˖🌆◗ 𝙀𝙭𝙤𝙩𝙞𝙘𝙤𝘽𝙤𝙩-𝙈𝘿... 🍹✨`, null, null, {viewOnce: true}, m)}
  
if (command == 'pornopies' || command == 'nsfwfoot') {
let res = (await axios.get(`https://raw.githubusercontent.com/MultiBot-OFC/ExoticoBot-MD/master/NODE_EXOTICO_JSON/node-exotico-anime/nsfwfoot.json`)).data  
let enlace = await res[Math.floor(res.length * Math.random())]  
await conn.sendFile(m.chat, enlace, null, `᥀·࣭࣪̇˖🌆◗ 𝙀𝙭𝙤𝙩𝙞𝙘𝙤𝘽𝙤𝙩-𝙈𝘿... 🍹✨`, null, null, {viewOnce: true}, m)}
  
if (command == 'pornoass' || command == 'nsfwass') {
let res = (await axios.get(`https://raw.githubusercontent.com/MultiBot-OFC/ExoticoBot-MD/master/NODE_EXOTICO_JSON/node-exotico-anime/nsfwass.json`)).data  
let enlace = await res[Math.floor(res.length * Math.random())]  
await conn.sendFile(m.chat, enlace, null, `᥀·࣭࣪̇˖🌆◗ 𝙀𝙭𝙤𝙩𝙞𝙘𝙤𝘽𝙤𝙩-𝙈𝘿... 🍹✨`, null, null, {viewOnce: true}, m)}
  
if (command == 'pornobdsm' || command == 'nsfwbdsm') {
let res = (await axios.get(`https://raw.githubusercontent.com/MultiBot-OFC/ExoticoBot-MD/master/NODE_EXOTICO_JSON/node-exotico-anime/nsfwbdsm.json`)).data  
let enlace = await res[Math.floor(res.length * Math.random())]  
await conn.sendFile(m.chat, enlace, null, `᥀·࣭࣪̇˖🌆◗ 𝙀𝙭𝙤𝙩𝙞𝙘𝙤𝘽𝙤𝙩-𝙈𝘿... 🍹✨`, null, null, {viewOnce: true}, m)}
  
if (command == 'pornocum' || command == 'nsfwcum') {
let res = (await axios.get(`https://raw.githubusercontent.com/MultiBot-OFC/ExoticoBot-MD/master/NODE_EXOTICO_JSON/node-exotico-anime/nsfwcum.json`)).data  
let enlace = await res[Math.floor(res.length * Math.random())]  
await conn.sendFile(m.chat, enlace, null, `᥀·࣭࣪̇˖🌆◗ 𝙀𝙭𝙤𝙩𝙞𝙘𝙤𝘽𝙤𝙩-𝙈𝘿... 🍹✨`, null, null, {viewOnce: true}, m)}
  
if (command == 'pornoero' || command == 'nsfwero') {
let res = (await axios.get(`https://raw.githubusercontent.com/MultiBot-OFC/ExoticoBot-MD/master/NODE_EXOTICO_JSON/node-exotico-anime/nsfwero.json`)).data  
let enlace = await res[Math.floor(res.length * Math.random())]  
await conn.sendFile(m.chat, enlace, null, `᥀·࣭࣪̇˖🌆◗ 𝙀𝙭𝙤𝙩𝙞𝙘𝙤𝘽𝙤𝙩-𝙈𝘿... 🍹✨`, null, null, {viewOnce: true}, m)}
 
if (command == 'pornodominar' || command == 'nsfwfemdom') {
let res = (await axios.get(`https://raw.githubusercontent.com/MultiBot-OFC/ExoticoBot-MD/master/NODE_EXOTICO_JSON/node-exotico-anime/nsfwfemdom.json`)).data  
let enlace = await res[Math.floor(res.length * Math.random())]  
await conn.sendFile(m.chat, enlace, null, `᥀·࣭࣪̇˖🌆◗ 𝙀𝙭𝙤𝙩𝙞𝙘𝙤𝘽𝙤𝙩-𝙈𝘿... 🍹✨`, null, null, {viewOnce: true}, m)}
 
if (command == 'pornoglass' || command == 'nsfwglass') {
let res = (await axios.get(`https://raw.githubusercontent.com/MultiBot-OFC/ExoticoBot-MD/master/NODE_EXOTICO_JSON/node-exotico-anime/nsfwglass.json`)).data  
let enlace = await res[Math.floor(res.length * Math.random())]  
await conn.sendFile(m.chat, enlace, null, `᥀·࣭࣪̇˖🌆◗ 𝙀𝙭𝙤𝙩𝙞𝙘𝙤𝘽𝙤𝙩-𝙈𝘿... 🍹✨`, null, null, {viewOnce: true}, m)}
  
if (command == 'pornohentai' || command == 'nsfwhentai') {
let res = (await axios.get(`https://raw.githubusercontent.com/MultiBot-OFC/ExoticoBot-MD/master/NODE_EXOTICO_JSON/node-exotico-anime/hentai.json`)).data  
let enlace = await res[Math.floor(res.length * Math.random())]  
await conn.sendFile(m.chat, enlace, null, `᥀·࣭࣪̇˖🌆◗ 𝙀𝙭𝙤𝙩𝙞𝙘𝙤𝘽𝙤𝙩-𝙈𝘿... 🍹✨`, null, null, {viewOnce: true}, m)}
 
if (command == 'pornorgia' || command == 'nsfworgy') {
let res = (await axios.get(`https://raw.githubusercontent.com/MultiBot-OFC/ExoticoBot-MD/master/NODE_EXOTICO_JSON/node-exotico-anime/nsfworgy.json`)).data  
let enlace = await res[Math.floor(res.length * Math.random())]
await conn.sendFile(m.chat, enlace, null, `᥀·࣭࣪̇˖🌆◗ 𝙀𝙭𝙤𝙩𝙞𝙘𝙤𝘽𝙤𝙩-𝙈𝘿... 🍹✨`, null, null, {viewOnce: true}, m)}
 
if (command == 'pornotetas' || command == 'nsfwboobs') {
let resError = (await axios.get(`https://raw.githubusercontent.com/MultiBot-OFC/ExoticoBot-MD/master/NODE_EXOTICO_JSON/node-exotico-anime/tetas.json`)).data   
let res = await conn.getFile(`https://api-fgmods.ddns.net/api/nsfw/boobs?apikey=fg-dylux`).data
if (res == '' || !res || res == null) res = await resError[Math.floor(resError.length * Math.random())]  
await conn.sendFile(m.chat, res, null, `᥀·࣭࣪̇˖🌆◗ 𝙀𝙭𝙤𝙩𝙞𝙘𝙤𝘽𝙤𝙩-𝙈𝘿... 🍹✨`, null, null, {viewOnce: true}, m)}
 
if (command == 'pornobooty' || command == 'nsfwbooty') {
let resError = (await axios.get(`https://raw.githubusercontent.com/MultiBot-OFC/ExoticoBot-MD/master/NODE_EXOTICO_JSON/node-exotico-anime/booty.json`)).data   
...
let res = (await axios.get(`https://raw.githubusercontent.com/MultiBot-OFC/ExoticoBot-MD/master/NODE_EXOTICO_JSON/node-exotico-anime/ecchi.json`)).data  
let enlace = await res[Math.floor(res.length * Math.random())]
await conn.sendFile(m.chat, enlace, null, `᥀·࣭࣪̇˖🌆◗ 𝙀𝙭𝙤𝙩𝙞𝙘𝙤𝘽𝙤𝙩-𝙈𝘿... 🍹✨`, null, null, {viewOnce: true}, m)}
  
if (command == 'pornofurro' || command == 'nsfwfurry') {
let res = (await axios.get(`https://raw.githubusercontent.com/MultiBot-OFC/ExoticoBot-MD/master/NODE_EXOTICO_JSON/node-exotico-anime/furro.json`)).data  
let enlace = await res[Math.floor(res.length * Math.random())]
await conn.sendFile(m.chat, enlace, null, `᥀·࣭࣪̇˖🌆◗ 𝙀𝙭𝙤𝙩𝙞𝙘𝙤𝘽𝙤𝙩-𝙈𝘿... 🍹✨`, null, null, {viewOnce: true}, m)}
...
let resError = (await axios.get(`https://raw.githubusercontent.com/MultiBot-OFC/ExoticoBot-MD/master/NODE_EXOTICO_JSON/node-exotico-anime/imagenlesbians.json`)).data   
...
let res = (await axios.get(`https://raw.githubusercontent.com/MultiBot-OFC/ExoticoBot-MD/master/NODE_EXOTICO_JSON/node-exotico-anime/panties.json`)).data  
let enlace = await res[Math.floor(res.length * Math.random())]
await conn.sendFile(m.chat, enlace, null, `᥀·࣭࣪̇˖🌆◗ 𝙀𝙭𝙤𝙩𝙞𝙘𝙤𝘽𝙤𝙩-𝙈𝘿... 🍹✨`, null, null, {viewOnce: true}, m)}
 
if (command == 'pornopene' || command == 'nsfwpenis') {
let resError = (await axios.get(`https://raw.githubusercontent.com/MultiBot-OFC/ExoticoBot-MD/master/NODE_EXOTICO_JSON/node-exotico-anime/pene.json`)).data   
let res = await conn.getFile(`https://api-fgmods.ddns.net/api/nsfw/penis?apikey=fg-dylux`).data
if (res == '' || !res || res == null) res = await resError[Math.floor(resError.length * Math.random())]  
await conn.sendFile(m.chat, res, null, `᥀·࣭࣪̇˖🌆◗ 𝙀𝙭𝙤𝙩𝙞𝙘𝙤𝘽𝙤𝙩-𝙈𝘿... 🍹✨`, null, null, {viewOnce: true}, m)}
  
if (command == 'porno' || command == 'porn') {
let res = (await axios.get(`https://raw.githubusercontent.com/MultiBot-OFC/ExoticoBot-MD/master/NODE_EXOTICO_JSON/node-exotico-anime/porno.json`)).data  
let enlace = await res[Math.floor(res.length * Math.random())]
await conn.sendFile(m.chat, res, null, `᥀·࣭࣪̇˖🌆◗ 𝙀𝙭𝙤𝙩𝙞𝙘𝙤𝘽𝙤𝙩-𝙈𝘿... 🍹✨`, null, null, {viewOnce: true}, m)}

if (command == 'pornorandom' || command == 'pornrandom') {
let rawjsonn = ['https://raw.githubusercontent.com/MultiBot-OFC/ExoticoBot-MD/master/NODE_EXOTICO_JSON/node-exotico-anime/tetas.json', 'https://raw.githubusercontent.com/MultiBot-OFC/ExoticoBot-MD/master/NODE_EXOTICO_JSON/node-exotico-anime/booty.json', 'https://raw.githubusercontent.com/MultiBot-OFC/ExoticoBot-MD/master/NODE_EXOTICO_JSON/node-exotico-anime/imagenlesbians.json', 'https://raw.githubusercontent.com/MultiBot-OFC/ExoticoBot-MD/master/NODE_EXOTICO_JSON/node-exotico-anime/panties.json', 'https://raw.githubusercontent.com/MultiBot-OFC/ExoticoBot-MD/master/NODE_EXOTICO_JSON/node-exotico-anime/porno.json'] 
...
let res = (await axios.get(`https://raw.githubusercontent.com/MultiBot-OFC/ExoticoBot-MD/master/NODE_EXOTICO_JSON/node-exotico-anime/pechos.json`)).data  
let enlace = await res[Math.floor(res.length * Math.random())]
await conn.sendFile(m.chat, enlace, null, `᥀·࣭࣪̇˖🌆◗ 𝙀𝙭𝙤𝙩𝙞𝙘𝙤𝘽𝙤𝙩-𝙈𝘿... 🍹✨`, null, null, {viewOnce: true}, m)}
 
if (command == 'pornoyaoi' || command == 'nsfwyaoi') {
let res = (await axios.get(`https://raw.githubusercontent.com/HasamiAini/wabot_takagisan/main/whatsapp%20bot%20takagisan/whatsapp%20bot%20takagisan/lib/Yaoi.json`)).data  //`https://raw.githubusercontent.com/MultiBot-OFC/ExoticoBot-MD/master/NODE_EXOTICO_JSON/node-exotico-anime/yaoi.json`
let enlace = await res[Math.floor(res.length * Math.random())]
let link = enlace.image
if (link.slice(-3) == 'gif') {
let stickerr = await sticker(false, link, global.packname, global.author)
await conn.sendFile(m.chat, stickerr, 'sticker.webp', '', m, true, { contextInfo: { 'forwardingScore': 200, 'isForwarded': false, externalAdReply:{ showAdAttribution: false, title: '『🥃 𝙀𝙭𝙤𝙩𝙞𝙘𝙤𝘽𝙤𝙩 ⸙ 〤18 🥃』', body: '🍹 𝘌𝘴𝘵𝘢𝘴 𝘴𝘪𝘦𝘯𝘥𝘰 𝘵𝘦𝘯𝘵𝘢𝘥𝘰, 𝘯𝘰 𝘷𝘦𝘢𝘴 𝘦𝘴𝘵𝘢𝘴 𝘤𝘰𝘴𝘢𝘴 𝘱𝘢𝘫𝘪𝘯', mediaType: 2, sourceUrl: redesMenu, thumbnail: await(await fetch(img16)).buffer()}}}, { quoted: m })
...
let res = (await axios.get(`https://raw.githubusercontent.com/MultiBot-OFC/ExoticoBot-MD/master/NODE_EXOTICO_JSON/node-exotico-anime/yuri.json`)).data  
let enlace = await res[Math.floor(res.length * Math.random())]  
await conn.sendFile(m.chat, enlace, null, `᥀·࣭࣪̇˖🌆◗ 𝙀𝙭𝙤𝙩𝙞𝙘𝙤𝘽𝙤𝙩-𝙈𝘿... 🍹✨`, null, null, {viewOnce: true}, m)}
...
//No hagan pasarse como si los codigos fueran suyos...