...
if (!isBotAdmin) return m.reply(IDexotic.offAdmin)
if (chat.delete) return m.reply(IDexotic.offDelete)   
if (isBotAdmin) {
if (m.text.includes(linkThisGroup)) return
await conn.sendMessage(m.chat, { text: `*${IDexotic.antiLink}*`, mentions: [m.sender] }, { quoted: m })    
