...
if (!isBotAdmin) return m.reply('᥀·࣭࣪̇˖👑◗ 𝙀𝙡 𝙖𝙙𝙢𝙞𝙣 𝙖𝙘𝙖𝙗𝙖 𝙙𝙚 𝙚𝙣𝙫𝙞𝙖𝙧 𝙪𝙣 𝙚𝙣𝙡𝙖𝙘𝙚, 𝙣𝙤 𝙨𝙚𝙧𝙖𝙨 𝙚𝙡𝙞𝙢𝙞𝙣𝙖𝙙𝙤 𝙥𝙤𝙧 𝙨𝙚𝙧 𝙖𝙙𝙢𝙞𝙣. 👺')
if (chat.delete) return m.reply('᥀·࣭࣪̇˖🎩◗ 𝘼𝙥𝙖𝙜𝙖 𝙚𝙡 𝙖𝙣𝙩𝙞𝙙𝙚𝙡𝙚𝙩𝙚 𝙥𝙖𝙧𝙖 𝙦𝙪𝙚 𝙚𝙡 𝙗𝙤𝙩 𝙣𝙤 𝙧𝙚𝙚𝙣𝙫𝙞𝙚 𝙢𝙚𝙣𝙨𝙖𝙟𝙚𝙨 𝙞𝙣𝙣𝙚𝙘𝙚𝙨𝙖𝙧𝙞𝙤𝙨.')   
if (isBotAdmin) {
if (m.text.includes(linkThisGroup)) return
await conn.sendMessage(m.chat, { text: `᥀·࣭࣪̇˖👺◗ 𝙀𝙣 𝙚𝙨𝙩𝙚 𝙜𝙧𝙪𝙥𝙤 𝙣𝙤 𝙨𝙚 𝙖𝙙𝙢𝙞𝙩𝙚 𝙚𝙣𝙫𝙞𝙖𝙧 𝙚𝙣𝙡𝙖𝙘𝙚𝙨 𝙜𝙧𝙪𝙥𝙖𝙡𝙚𝙨.`, mentions: [m.sender] }, { quoted: m })    
