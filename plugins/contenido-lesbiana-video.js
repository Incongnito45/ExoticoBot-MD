...
let res = await adultovid[Math.floor(Math.random() * adultovid.length)]
...
conn.sendMessage(m.chat, { video: { url: res }, caption: `• *_${command}_*` }, { quoted: m })}
handler.help = ['wlesbiana']
handler.tags = ['adultos']
handler.command = /^(vlesbiana)$/i
