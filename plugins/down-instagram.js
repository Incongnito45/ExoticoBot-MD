...
if (!args[0]) throw `᥀·࣭࣪̇˖☁️◗ 𝙄𝙣𝙜𝙧𝙚𝙨𝙚 𝙪𝙣 𝙚𝙣𝙡𝙖𝙘𝙚 𝙙𝙚 𝙄𝙣𝙨𝙩𝙖𝙜𝙧𝙖𝙢 𝙫𝙖𝙡𝙞𝙙𝙤.\n𝙋𝙤𝙧 𝙚𝙟𝙚𝙢𝙥𝙡𝙤: *${usedPrefix + command} https://www.instagram.com/p/CCoI4DQBGVQ/?igshid=YmMyMTA2M2Y=*`
...
const tXXxt = `᥀·࣭࣪̇˖🌆◗ 𝙄𝙣𝙨𝙩𝙖𝙜𝙧𝙖𝙢... ✨`.trim();
...
const txt1 = `᥀·࣭࣪̇˖🌆◗ 𝙄𝙣𝙨𝙩𝙖𝙜𝙧𝙖𝙢... ✨`.trim();
await conn.sendFile(m.chat, videoig, 'error.mp4', txt1, m);
await conn.sendMessage(m.chat, {text: waittttt, edit: key})
} catch (e) {
conn.sendMessage(m.chat, {text: `${errorAB}`, edit: key});
console.log(`${errorBB}`)
console.log(e)
handler.limit = 0
}}}}}}
